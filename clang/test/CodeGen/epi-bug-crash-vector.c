...
// CHECK-NEXT:    store <vscale x 2 x i32> [[A:%.*]], ptr [[A_ADDR]], align 4
// CHECK-NEXT:    store <vscale x 2 x i32> [[B:%.*]], ptr [[B_ADDR]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load <vscale x 2 x i32>, ptr [[B_ADDR]], align 4
...
// CHECK-NEXT:    store i32 [[CONV]], ptr [[GVL]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[GVL]], align 4
// CHECK-NEXT:    [[CONV1:%.*]] = sext i32 [[TMP1]] to i64
// CHECK-NEXT:    [[TMP2:%.*]] = call <vscale x 2 x i32> @llvm.epi.vmv.v.x.nxv2i32.i32(i32 1, i64 [[CONV1]])
// CHECK-NEXT:    store <vscale x 2 x i32> [[TMP2]], ptr [[VA]], align 4
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[GVL]], align 4
// CHECK-NEXT:    [[CONV2:%.*]] = sext i32 [[TMP3]] to i64
// CHECK-NEXT:    [[TMP4:%.*]] = call <vscale x 2 x i32> @llvm.epi.vmv.v.x.nxv2i32.i32(i32 2, i64 [[CONV2]])
// CHECK-NEXT:    store <vscale x 2 x i32> [[TMP4]], ptr [[VB]], align 4
// CHECK-NEXT:    [[TMP5:%.*]] = load <vscale x 2 x i32>, ptr [[VA]], align 4
// CHECK-NEXT:    [[TMP6:%.*]] = load <vscale x 2 x i32>, ptr [[VB]], align 4
// CHECK-NEXT:    [[CALL:%.*]] = call <vscale x 2 x i32> @second(<vscale x 2 x i32> noundef [[TMP5]], <vscale x 2 x i32> noundef [[TMP6]])
// CHECK-NEXT:    store <vscale x 2 x i32> [[CALL]], ptr [[VC]], align 4
