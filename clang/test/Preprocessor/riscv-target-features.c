...
// CHECK-EPI-FLAG: __epi 1
// CHECK-EPI-FLAG: __riscv_v_elen 64
// CHECK-EPI-FLAG: __riscv_v_elen_fp 64
// CHECK-EPI-FLAG: __riscv_v_min_vlen 64
// CHECK-EPI-FLAG: __riscv_vector 1
