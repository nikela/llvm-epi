...
#pragma omp declare simd simdlen(1) // expected-warning {{omp_max_simdlen is required in EPI.}}
#pragma omp declare simd simdlen(omp_max_simdlen)
#pragma omp declare simd simdlen(omp_max_simdlen: 1)
#pragma omp declare simd simdlen(omp_max_simdlen: 5) // expected-warning {{The value specified in simdlen must be a power of 2.}}
float fsquare(float a) {
  return a * a;
}

// RISCV64: "_ZGVEMk1v_fsquare" "_ZGVEMk2v_fsquare" "_ZGVEMk4v_fsquare" "_ZGVEMk8v_fsquare" "_ZGVENk1v_fsquare" "_ZGVENk2v_fsquare" "_ZGVENk4v_fsquare" "_ZGVENk8v_fsquare"
...
#pragma omp declare simd simdlen(omp_max_simdlen: 1) linear(a : 1)
...
#pragma omp declare simd simdlen(omp_max_simdlen: 1) uniform(b)
