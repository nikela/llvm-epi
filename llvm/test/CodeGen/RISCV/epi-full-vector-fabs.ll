...
; CHECK-NEXT:    vfsgnjx.vv v2, v16, v16
...
; CHECK-LABEL: nxv4f32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32,m2
; CHECK-NEXT:    vfsgnjx.vv v2, v16, v16
; CHECK-NEXT:    vmv2r.v v16, v2
; CHECK-NEXT:    ret
...
; CHECK-LABEL: nxv4f64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64,m4
; CHECK-NEXT:    vfsgnjx.vv v4, v16, v16
...
; CHECK-LABEL: nxv8f32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32,m4
; CHECK-NEXT:    vfsgnjx.vv v4, v16, v16
; CHECK-NEXT:    vmv4r.v v16, v4
; CHECK-NEXT:    ret
...
; CHECK-LABEL: nxv8f64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64,m8
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32,m8
; CHECK-NEXT:    vfsgnjx.vv v8, v16, v16
; CHECK-NEXT:    vmv8r.v v16, v8
; CHECK-NEXT:    ret
