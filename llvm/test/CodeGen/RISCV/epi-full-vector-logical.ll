...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 1 x i1> %log_1, <vscale x 1 x i1>* %store_addr

  %log_2 = or <vscale x 1 x i1> %a, %b
  store volatile <vscale x 1 x i1> %log_2, <vscale x 1 x i1>* %store_addr

  %log_3 = xor <vscale x 1 x i1> %a, %b
  store volatile <vscale x 1 x i1> %log_3, <vscale x 1 x i1>* %store_addr
...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 2 x i1> %log_1, <vscale x 2 x i1>* %store_addr

  %log_2 = or <vscale x 2 x i1> %a, %b
  store volatile <vscale x 2 x i1> %log_2, <vscale x 2 x i1>* %store_addr

  %log_3 = xor <vscale x 2 x i1> %a, %b
  store volatile <vscale x 2 x i1> %log_3, <vscale x 2 x i1>* %store_addr
...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 4 x i1> %log_1, <vscale x 4 x i1>* %store_addr

  %log_2 = or <vscale x 4 x i1> %a, %b
  store volatile <vscale x 4 x i1> %log_2, <vscale x 4 x i1>* %store_addr

  %log_3 = xor <vscale x 4 x i1> %a, %b
  store volatile <vscale x 4 x i1> %log_3, <vscale x 4 x i1>* %store_addr
...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 8 x i1> %log_1, <vscale x 8 x i1>* %store_addr

  %log_2 = or <vscale x 8 x i1> %a, %b
  store volatile <vscale x 8 x i1> %log_2, <vscale x 8 x i1>* %store_addr

  %log_3 = xor <vscale x 8 x i1> %a, %b
  store volatile <vscale x 8 x i1> %log_3, <vscale x 8 x i1>* %store_addr
...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 16 x i1> %log_1, <vscale x 16 x i1>* %store_addr

  %log_2 = or <vscale x 16 x i1> %a, %b
  store volatile <vscale x 16 x i1> %log_2, <vscale x 16 x i1>* %store_addr

  %log_3 = xor <vscale x 16 x i1> %a, %b
  store volatile <vscale x 16 x i1> %log_3, <vscale x 16 x i1>* %store_addr
...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 32 x i1> %log_1, <vscale x 32 x i1>* %store_addr

  %log_2 = or <vscale x 32 x i1> %a, %b
  store volatile <vscale x 32 x i1> %log_2, <vscale x 32 x i1>* %store_addr

  %log_3 = xor <vscale x 32 x i1> %a, %b
  store volatile <vscale x 32 x i1> %log_3, <vscale x 32 x i1>* %store_addr
...
; CHECK-NEXT:    ret
  ...
  store volatile <vscale x 64 x i1> %log_1, <vscale x 64 x i1>* %store_addr

  %log_2 = or <vscale x 64 x i1> %a, %b
  store volatile <vscale x 64 x i1> %log_2, <vscale x 64 x i1>* %store_addr

  %log_3 = xor <vscale x 64 x i1> %a, %b
  store volatile <vscale x 64 x i1> %log_3, <vscale x 64 x i1>* %store_addr
