...
; RUN: llc -mtriple=riscv32 -verify-machineinstrs -riscv-local-stack-allocation < %s | FileCheck %s --check-prefix=RV32I
; RUN: llc -mtriple=riscv64 -verify-machineinstrs -riscv-local-stack-allocation < %s | FileCheck %s --check-prefix=RV64I
...
; RV32I:       # %bb.0:
; RV32I-NEXT:    lui t2, 25
; RV32I-NEXT:    addi t2, t2, -1792
; RV32I-NEXT:    sub sp, sp, t2
...
; RV64I:       # %bb.0:
; RV64I-NEXT:    lui t2, 25
; RV64I-NEXT:    addiw t2, t2, -1792
; RV64I-NEXT:    sub sp, sp, t2
