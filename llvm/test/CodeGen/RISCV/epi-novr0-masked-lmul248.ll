...
define void @test_lmul_1(<vscale x 1 x double>* %a0, <vscale x 1 x double>* %a1, <vscale x 1 x double>* %a2, <vscale x 1 x i64>* %a3, <vscale x 1 x i1> %m, i32 %n) nounwind {
  ...
  ; CHECK:   [[PseudoEPIVLE64_V_M1_:%[0-9]+]]:vr = PseudoEPIVLE64_V_M1 [[DEF]], [[COPY3]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF1:%[0-9]+]]:vr = IMPLICIT_DEF
  ; CHECK:   dead %15:gpr = PseudoVSETVLI [[COPY]], 88, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVLE64_V_M1_1:%[0-9]+]]:vr = PseudoEPIVLE64_V_M1 [[DEF1]], [[COPY2]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF2:%[0-9]+]]:vr = IMPLICIT_DEF
  ; CHECK:   dead %16:gpr = PseudoVSETVLI [[COPY]], 88, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVFADD_VV_M1_:%[0-9]+]]:vr = PseudoEPIVFADD_VV_M1 [[DEF2]], killed [[PseudoEPIVLE64_V_M1_]], killed [[PseudoEPIVLE64_V_M1_1]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   dead %17:gpr = PseudoVSETVLI [[COPY]], 88, implicit-def $vl, implicit-def $vtype
  ; CHECK:   PseudoEPIVSE64_V_M1 killed [[PseudoEPIVFADD_VV_M1_]], killed [[ADDI]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   PseudoRET
...
define void @test_lmul_2(<vscale x 2 x double>* %a0, <vscale x 2 x double>* %a1, <vscale x 2 x double>* %a2, <vscale x 2 x i64>* %a3, <vscale x 2 x i1> %m, i32 %n) nounwind {
  ...
  ; CHECK:   [[PseudoEPIVLE64_V_M2_:%[0-9]+]]:vrm2nov0 = PseudoEPIVLE64_V_M2 [[DEF]], [[COPY3]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF1:%[0-9]+]]:vrm2 = IMPLICIT_DEF
  ; CHECK:   dead %15:gpr = PseudoVSETVLI [[COPY]], 89, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVLE64_V_M2_1:%[0-9]+]]:vrm2nov0 = PseudoEPIVLE64_V_M2 [[DEF1]], [[COPY2]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF2:%[0-9]+]]:vrm2 = IMPLICIT_DEF
  ; CHECK:   dead %16:gpr = PseudoVSETVLI [[COPY]], 89, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVFADD_VV_M2_:%[0-9]+]]:vrm2nov0 = PseudoEPIVFADD_VV_M2 [[DEF2]], killed [[PseudoEPIVLE64_V_M2_]], killed [[PseudoEPIVLE64_V_M2_1]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   dead %17:gpr = PseudoVSETVLI [[COPY]], 89, implicit-def $vl, implicit-def $vtype
  ; CHECK:   PseudoEPIVSE64_V_M2 killed [[PseudoEPIVFADD_VV_M2_]], killed [[ADDI]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   PseudoRET
...
define void @test_lmul_4(<vscale x 4 x double>* %a0, <vscale x 4 x double>* %a1, <vscale x 4 x double>* %a2, <vscale x 4 x i64>* %a3, <vscale x 4 x i1> %m, i32 %n) nounwind {
  ...
  ; CHECK:   [[PseudoEPIVLE64_V_M4_:%[0-9]+]]:vrm4nov0 = PseudoEPIVLE64_V_M4 [[DEF]], [[COPY3]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF1:%[0-9]+]]:vrm4 = IMPLICIT_DEF
  ; CHECK:   dead %15:gpr = PseudoVSETVLI [[COPY]], 90, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVLE64_V_M4_1:%[0-9]+]]:vrm4nov0 = PseudoEPIVLE64_V_M4 [[DEF1]], [[COPY2]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF2:%[0-9]+]]:vrm4 = IMPLICIT_DEF
  ; CHECK:   dead %16:gpr = PseudoVSETVLI [[COPY]], 90, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVFADD_VV_M4_:%[0-9]+]]:vrm4nov0 = PseudoEPIVFADD_VV_M4 [[DEF2]], killed [[PseudoEPIVLE64_V_M4_]], killed [[PseudoEPIVLE64_V_M4_1]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   dead %17:gpr = PseudoVSETVLI [[COPY]], 90, implicit-def $vl, implicit-def $vtype
  ; CHECK:   PseudoEPIVSE64_V_M4 killed [[PseudoEPIVFADD_VV_M4_]], killed [[ADDI]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   PseudoRET
...
define void @test_lmul_8(<vscale x 8 x double>* %a0, <vscale x 8 x double>* %a1, <vscale x 8 x double>* %a2, <vscale x 8 x i64>* %a3, <vscale x 8 x i1> %m, i32 %n) nounwind {
  ...
  ; CHECK:   [[PseudoEPIVLE64_V_M8_:%[0-9]+]]:vrm8nov0 = PseudoEPIVLE64_V_M8 [[DEF]], [[COPY3]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF1:%[0-9]+]]:vrm8 = IMPLICIT_DEF
  ; CHECK:   dead %15:gpr = PseudoVSETVLI [[COPY]], 91, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVLE64_V_M8_1:%[0-9]+]]:vrm8nov0 = PseudoEPIVLE64_V_M8 [[DEF1]], [[COPY2]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   [[DEF2:%[0-9]+]]:vrm8 = IMPLICIT_DEF
  ; CHECK:   dead %16:gpr = PseudoVSETVLI [[COPY]], 91, implicit-def $vl, implicit-def $vtype
  ; CHECK:   [[PseudoEPIVFADD_VV_M8_:%[0-9]+]]:vrm8nov0 = PseudoEPIVFADD_VV_M8 [[DEF2]], killed [[PseudoEPIVLE64_V_M8_]], killed [[PseudoEPIVLE64_V_M8_1]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   $v0 = COPY [[COPY1]]
  ; CHECK:   dead %17:gpr = PseudoVSETVLI [[COPY]], 91, implicit-def $vl, implicit-def $vtype
  ; CHECK:   PseudoEPIVSE64_V_M8 killed [[PseudoEPIVFADD_VV_M8_]], killed [[ADDI]], $v0, $noreg, -1, implicit $vl, implicit $vtype
  ; CHECK:   PseudoRET
