...
; CHECK-O0-NEXT:    vsetvli a0, a2, e32,m1,ta,mu
; CHECK-O0-NEXT:    vle32.v v27, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v26
; CHECK-O0-NEXT:    vsetvli a0, a2, e64,m1,ta,mu
...
; CHECK-O0-NEXT:    vsetvli a1, a2, e64,m1,ta,mu
; CHECK-O0-NEXT:    vse64.v v26, (a0)
; CHECK-O0-NEXT:    vsetvli a1, a2, e32,m1,ta,mu
...
; CHECK-O2-NEXT:    vsetvli a0, a2, e32,m1,ta,mu
...
; CHECK-O2-NEXT:    vsetvli a1, a2, e32,m1,ta,mu
...
; CHECK-O0-NEXT:    vsetvli a0, a2, e64,m2,ta,mu
; CHECK-O0-NEXT:    vle64.v v28, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vsetvli a0, a2, e64,m1,ta,mu
...
; CHECK-O0-NEXT:    vsetvli a1, a2, e64,m2,ta,mu
; CHECK-O0-NEXT:    vse64.v v26, (a0)
; CHECK-O0-NEXT:    ret
;
