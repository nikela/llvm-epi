...
; CHECK-O0-NEXT:    vsetvli a3, a1, e64,m2,ta,mu
; CHECK-O0-NEXT:    vle64.v v4, (a0)
; CHECK-O0-NEXT:    # implicit-def: $v1
; CHECK-O0-NEXT:    vsetvli a0, a2, e64,m1,ta,mu
; CHECK-O0-NEXT:    vfadd.vv v1, v2, v2
; CHECK-O0-NEXT:    # implicit-def: $v2m2
; CHECK-O0-NEXT:    vsetvli a0, a1, e64,m2,ta,mu
...
; CHECK-O2-NEXT:    vfadd.vv v1, v1, v1
; CHECK-O2-NEXT:    vsetvli a0, a2, e64,m2,ta,mu
; CHECK-O2-NEXT:    vfadd.vv v4, v2, v2
; CHECK-O2-NEXT:    lui a0, %hi(scratch)
; CHECK-O2-NEXT:    addi a0, a0, %lo(scratch)
; CHECK-O2-NEXT:    vsetvli a1, a2, e64,m1,ta,mu
; CHECK-O2-NEXT:    vse64.v v1, (a0)
