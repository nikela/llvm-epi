...
; CHECK-NEXT:    sd ra, 216(sp)
; CHECK-NEXT:    sd s0, 208(sp)
; CHECK-NEXT:    sd s1, 200(sp)
; CHECK-NEXT:    sd s2, 192(sp)
; CHECK-NEXT:    sd s3, 184(sp)
; CHECK-NEXT:    sd s4, 176(sp)
; CHECK-NEXT:    sd s5, 168(sp)
; CHECK-NEXT:    sd s6, 160(sp)
; CHECK-NEXT:    sd s7, 152(sp)
; CHECK-NEXT:    sd s8, 144(sp)
; CHECK-NEXT:    sd s9, 136(sp)
; CHECK-NEXT:    sd s10, 128(sp)
; CHECK-NEXT:    sd s11, 120(sp)
...
; CHECK-NEXT:    slli s7, a3, 5
; CHECK-NEXT:    slli s8, a3, 6
; CHECK-NEXT:    ld a3, -136(s0)
; CHECK-NEXT:  .LBB0_2: # %for.body
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    vle.v v1, (a1)
; CHECK-NEXT:    addi a2, a1, 16
; CHECK-NEXT:    vle.v v6, (a2)
...
; CHECK-NEXT:    ld a4, -216(s0)
; CHECK-NEXT:    rdvlenb a2
; CHECK-NEXT:    add a2, a2, a4
; CHECK-NEXT:    vs1r.v v1, (a4)
...
; CHECK-NEXT:    add s11, a0, s7
; CHECK-NEXT:    vle.v v11, (s11)
...
; CHECK-NEXT:    add t5, a0, s6
; CHECK-NEXT:    vle.v v6, (t5)
...
; CHECK-NEXT:    add a7, a0, s5
; CHECK-NEXT:    vle.v v6, (a7)
...
; CHECK-NEXT:    vfsgnjn.vv v6, v6, v6, v0.t
; CHECK-NEXT:    vtrn.vv v1, v6, v6
; CHECK-NEXT:    add t0, a0, s4
; CHECK-NEXT:    vle.v v8, (t0)
...
; CHECK-NEXT:    ld a2, -128(s0)
; CHECK-NEXT:    add s10, a0, a2
; CHECK-NEXT:    vle.v v15, (s10)
...
; CHECK-NEXT:    add s1, a0, t6
; CHECK-NEXT:    vle.v v24, (s1)
...
; CHECK-NEXT:    ld a2, -184(s0)
; CHECK-NEXT:    add a4, a0, a2
; CHECK-NEXT:    vle.v v3, (a4)
...
; CHECK-NEXT:    ld a2, -176(s0)
; CHECK-NEXT:    add a6, a0, a2
; CHECK-NEXT:    vle.v v4, (a6)
...
; CHECK-NEXT:    ld a2, -160(s0)
; CHECK-NEXT:    add t3, a0, a2
; CHECK-NEXT:    vle.v v28, (t3)
...
; CHECK-NEXT:    vfsgnjn.vv v1, v1, v1, v0.t
; CHECK-NEXT:    add t4, a0, a3
; CHECK-NEXT:    vle.v v26, (t4)
; CHECK-NEXT:    vtrn.vv v27, v1, v1
; CHECK-NEXT:    vtrn.vv v27, v28, v1
; CHECK-NEXT:    vfnmsac.vv v12, v10, v27
; CHECK-NEXT:    sd a1, -112(s0)
; CHECK-NEXT:    sd a4, -120(s0)
; CHECK-NEXT:    ld a4, -216(s0)
; CHECK-NEXT:    rdvlenb a1
; CHECK-NEXT:    add a1, a1, a4
; CHECK-NEXT:    vl1r.v v3, (a4)
; CHECK-NEXT:    ld a4, -120(s0)
; CHECK-NEXT:    vl1r.v v4, (a1)
...
; CHECK-NEXT:    vse.v v28, (t1)
; CHECK-NEXT:    vfadd.vv v5, v29, v5
; CHECK-NEXT:    vse.v v5, (t0)
; CHECK-NEXT:    vfsub.vv v1, v27, v1
; CHECK-NEXT:    vse.v v1, (a7)
...
; CHECK-NEXT:    vse.v v7, (s11)
; CHECK-NEXT:    vfadd.vv v7, v19, v22
; CHECK-NEXT:    vse.v v7, (a0)
; CHECK-NEXT:    vfsub.vv v3, v6, v3
; CHECK-NEXT:    vse.v v3, (t5)
...
; CHECK-NEXT:    vse.v v5, (a5)
; CHECK-NEXT:    vfadd.vv v4, v4, v6
; CHECK-NEXT:    vse.v v4, (a2)
; CHECK-NEXT:    vfsub.vv v1, v1, v2
; CHECK-NEXT:    vse.v v1, (s10)
; CHECK-NEXT:    addi s9, s9, -1
; CHECK-NEXT:    ld a2, -144(s0)
; CHECK-NEXT:    add a0, a0, a2
; CHECK-NEXT:    addi a1, a1, 64
; CHECK-NEXT:    bnez s9, .LBB0_2
; CHECK-NEXT:  .LBB0_3: # %for.end
; CHECK-NEXT:    addi sp, s0, -224
; CHECK-NEXT:    ld s11, 120(sp)
; CHECK-NEXT:    ld s10, 128(sp)
; CHECK-NEXT:    ld s9, 136(sp)
; CHECK-NEXT:    ld s8, 144(sp)
; CHECK-NEXT:    ld s7, 152(sp)
; CHECK-NEXT:    ld s6, 160(sp)
; CHECK-NEXT:    ld s5, 168(sp)
; CHECK-NEXT:    ld s4, 176(sp)
; CHECK-NEXT:    ld s3, 184(sp)
; CHECK-NEXT:    ld s2, 192(sp)
; CHECK-NEXT:    ld s1, 200(sp)
; CHECK-NEXT:    ld s0, 208(sp)
; CHECK-NEXT:    ld ra, 216(sp)
; CHECK-NEXT:    addi sp, sp, 224
; CHECK-NEXT:    ret
entry:
