...
; RUN: llc -mtriple=riscv32 -mattr=+experimental-v,+experimental-zfh,+f,+d -verify-machineinstrs -riscv-v-vector-bits-min=128 -riscv-v-fixed-length-vector-lmul-max=1 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,LMULMAX1
; RUN: llc -mtriple=riscv64 -mattr=+experimental-v,+experimental-zfh,+f,+d -verify-machineinstrs -riscv-v-vector-bits-min=128 -riscv-v-fixed-length-vector-lmul-max=1 -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,LMULMAX1
...
; LMULMAX1-NEXT:    vle16.v v27, (a2)
; LMULMAX1-NEXT:    vle16.v v28, (a1)
; LMULMAX1-NEXT:    vfadd.vv v26, v27, v26
; LMULMAX1-NEXT:    vfadd.vv v25, v25, v28
...
; LMULMAX1-NEXT:    vle16.v v27, (a2)
; LMULMAX1-NEXT:    vle16.v v28, (a1)
; LMULMAX1-NEXT:    vfsub.vv v26, v27, v26
; LMULMAX1-NEXT:    vfsub.vv v25, v25, v28
; LMULMAX1-NEXT:    vse16.v v25, (a0)
; LMULMAX1-NEXT:    vse16.v v26, (a2)
; LMULMAX1-NEXT:    ret
  %a = load <16 x half>, <16 x half>* %x
...
; LMULMAX1-NEXT:    vle16.v v27, (a2)
; LMULMAX1-NEXT:    vle16.v v28, (a1)
; LMULMAX1-NEXT:    vfmul.vv v26, v27, v26
; LMULMAX1-NEXT:    vfmul.vv v25, v25, v28
; LMULMAX1-NEXT:    vse16.v v25, (a0)
; LMULMAX1-NEXT:    vse16.v v26, (a2)
; LMULMAX1-NEXT:    ret
  %a = load <16 x half>, <16 x half>* %x
...
; LMULMAX1-NEXT:    vle16.v v27, (a2)
; LMULMAX1-NEXT:    vle16.v v28, (a1)
; LMULMAX1-NEXT:    vfdiv.vv v26, v27, v26
; LMULMAX1-NEXT:    vfdiv.vv v25, v25, v28
; LMULMAX1-NEXT:    vse16.v v25, (a0)
; LMULMAX1-NEXT:    vse16.v v26, (a2)
; LMULMAX1-NEXT:    ret
  %a = load <16 x half>, <16 x half>* %x
...
; LMULMAX1-NEXT:    vfneg.v v25, v25
; LMULMAX1-NEXT:    vfneg.v v26, v26
