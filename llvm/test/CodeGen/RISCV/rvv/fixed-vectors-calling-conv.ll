...
; LMULMAX1:       # %bb.0:
; LMULMAX1-NEXT:    addi sp, sp, -176
; LMULMAX1-NEXT:    .cfi_def_cfa_offset 176
; LMULMAX1-NEXT:    sd ra, 168(sp) # 8-byte Folded Spill
; LMULMAX1-NEXT:    .cfi_offset ra, -8
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, mu
; LMULMAX1-NEXT:    vle32.v v24, (a0)
; LMULMAX1-NEXT:    addi a1, a0, 16
...
; LMULMAX1-NEXT:    addi a0, a0, 112
; LMULMAX1-NEXT:    vle32.v v31, (a0)
; LMULMAX1-NEXT:    ld a0, 176(sp)
; LMULMAX1-NEXT:    addi a1, sp, 144
; LMULMAX1-NEXT:    vse32.v v15, (a1)
; LMULMAX1-NEXT:    addi a1, sp, 128
; LMULMAX1-NEXT:    vse32.v v14, (a1)
; LMULMAX1-NEXT:    addi a1, sp, 112
; LMULMAX1-NEXT:    vse32.v v13, (a1)
; LMULMAX1-NEXT:    addi a1, sp, 96
; LMULMAX1-NEXT:    vse32.v v12, (a1)
; LMULMAX1-NEXT:    addi a1, sp, 80
; LMULMAX1-NEXT:    vse32.v v11, (a1)
; LMULMAX1-NEXT:    addi a1, sp, 64
; LMULMAX1-NEXT:    vse32.v v10, (a1)
; LMULMAX1-NEXT:    addi a1, sp, 48
; LMULMAX1-NEXT:    vse32.v v9, (a1)
...
; LMULMAX1-NEXT:    ld ra, 168(sp) # 8-byte Folded Reload
; LMULMAX1-NEXT:    addi sp, sp, 176
; LMULMAX1-NEXT:    ret
...
; LMULMAX1:       # %bb.0:
; LMULMAX1-NEXT:    addi sp, sp, -112
; LMULMAX1-NEXT:    .cfi_def_cfa_offset 112
; LMULMAX1-NEXT:    sd ra, 104(sp) # 8-byte Folded Spill
; LMULMAX1-NEXT:    .cfi_offset ra, -8
...
; LMULMAX1-NEXT:    ld ra, 104(sp) # 8-byte Folded Reload
; LMULMAX1-NEXT:    addi sp, sp, 112
; LMULMAX1-NEXT:    ret
