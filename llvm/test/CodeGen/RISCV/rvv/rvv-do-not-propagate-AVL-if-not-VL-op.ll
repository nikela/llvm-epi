...
; CHECK-NEXT:    ret
  ...
  %res = call <vscale x 1 x i1> @llvm.riscv.vmsgt.nxv1i64.i64(<vscale x 1 x i64> %vec, i64 %sum, i64 %evl)
  ret <vscale x 1 x i1> %res
}

declare i64 @llvm.riscv.vsetvli.i64(i64, i64, i64)
declare <vscale x 1 x i1> @llvm.riscv.vmsgt.nxv1i64.i64(<vscale x 1 x i64>, i64, i64);
