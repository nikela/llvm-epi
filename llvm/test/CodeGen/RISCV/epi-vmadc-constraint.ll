...
; CHECK-LABEL: foo:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    addi sp, sp, -368
; CHECK-NEXT:    .cfi_def_cfa_offset 368
; CHECK-NEXT:    sd ra, 360(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s0, 352(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s1, 344(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s2, 336(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s3, 328(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s4, 320(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s5, 312(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s6, 304(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s7, 296(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s8, 288(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s9, 280(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s10, 272(sp) # 8-byte Folded Spill
; CHECK-NEXT:    sd s11, 264(sp) # 8-byte Folded Spill
...
; CHECK-NEXT:    vmv.v.x v1, a4
; CHECK-NEXT:    ld a4, -280(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, a7
...
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, t1
; CHECK-NEXT:    ld a4, -304(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, t2
; CHECK-NEXT:    ld a4, -312(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, t3
...
; CHECK-NEXT:    vmv.v.x v1, t4
; CHECK-NEXT:    ld a4, -328(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, t5
; CHECK-NEXT:    ld a4, -336(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, t6
; CHECK-NEXT:    ld a4, -344(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v1, s2
...
; CHECK-NEXT:    vmv.v.x v1, s3
; CHECK-NEXT:    ld a4, -360(s0)
; CHECK-NEXT:    vs1r.v v1, (a4)
; CHECK-NEXT:    vmv.v.x v23, s5
; CHECK-NEXT:    vmv.v.x v8, s8
; CHECK-NEXT:    vmv.v.x v9, s9
...
; CHECK-NEXT:    vid.v v3
; CHECK-NEXT:    vmxor.mm v0, v1, v1
; CHECK-NEXT:    vmv.v.x v2, a4
; CHECK-NEXT:    vadc.vvm v10, v2, v3, v0
; CHECK-NEXT:    vmadc.vvm v1, v2, v3, v0
; CHECK-NEXT:    vmv.v.x v2, a3
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vadc.vim v11, v2, 0, v0
...
; CHECK-NEXT:    vl1r.v v27, (a3)
; CHECK-NEXT:    ld a3, -352(s0)
; CHECK-NEXT:    vl1r.v v31, (a3)
; CHECK-NEXT:    ld a3, -360(s0)
; CHECK-NEXT:    vl1r.v v14, (a3)
; CHECK-NEXT:    vmv1r.v v13, v23
; CHECK-NEXT:    vmv1r.v v15, v10
; CHECK-NEXT:    vmv1r.v v25, v11
; CHECK-NEXT:    vmv1r.v v24, v8
; CHECK-NEXT:    vmv1r.v v12, v9
; CHECK-NEXT:  .LBB0_4: # %for.body
; CHECK-NEXT:    # Parent Loop BB0_3 Depth=1
; CHECK-NEXT:    # => This Inner Loop Header: Depth=2
; CHECK-NEXT:    vadd.vv v2, v4, v16
; CHECK-NEXT:    vxor.vv v4, v15, v2
; CHECK-NEXT:    vsll.vi v15, v4, 16
; CHECK-NEXT:    vsrl.vi v4, v4, 16
; CHECK-NEXT:    vxor.vv v15, v15, v4
; CHECK-NEXT:    vadd.vv v26, v27, v15
; CHECK-NEXT:    vxor.vv v4, v16, v26
; CHECK-NEXT:    vsll.vi v16, v4, 12
; CHECK-NEXT:    vsrl.vi v4, v4, 20
; CHECK-NEXT:    vxor.vv v27, v16, v4
; CHECK-NEXT:    vadd.vv v4, v2, v27
; CHECK-NEXT:    vxor.vv v2, v15, v4
; CHECK-NEXT:    vsll.vi v16, v2, 8
; CHECK-NEXT:    vsrl.vi v2, v2, 24
; CHECK-NEXT:    vxor.vv v15, v16, v2
; CHECK-NEXT:    vadd.vv v16, v26, v15
; CHECK-NEXT:    vxor.vv v2, v27, v16
; CHECK-NEXT:    vsll.vi v26, v2, 7
; CHECK-NEXT:    vsrl.vi v2, v2, 25
; CHECK-NEXT:    vxor.vv v2, v26, v2
; CHECK-NEXT:    vadd.vv v7, v7, v30
; CHECK-NEXT:    vxor.vv v25, v25, v7
; CHECK-NEXT:    vsll.vi v26, v25, 16
; CHECK-NEXT:    vsrl.vi v25, v25, 16
; CHECK-NEXT:    vxor.vv v25, v26, v25
; CHECK-NEXT:    vadd.vv v26, v31, v25
; CHECK-NEXT:    vxor.vv v27, v30, v26
; CHECK-NEXT:    vsll.vi v30, v27, 12
; CHECK-NEXT:    vsrl.vi v27, v27, 20
; CHECK-NEXT:    vxor.vv v27, v30, v27
; CHECK-NEXT:    vadd.vv v7, v7, v27
; CHECK-NEXT:    vxor.vv v25, v25, v7
; CHECK-NEXT:    vsll.vi v30, v25, 8
; CHECK-NEXT:    vsrl.vi v25, v25, 24
; CHECK-NEXT:    vxor.vv v25, v30, v25
; CHECK-NEXT:    vadd.vv v26, v26, v25
; CHECK-NEXT:    vxor.vv v27, v27, v26
; CHECK-NEXT:    vsll.vi v30, v27, 7
; CHECK-NEXT:    vsrl.vi v27, v27, 25
; CHECK-NEXT:    vxor.vv v27, v30, v27
; CHECK-NEXT:    vadd.vv v6, v6, v29
; CHECK-NEXT:    vxor.vv v24, v24, v6
; CHECK-NEXT:    vsll.vi v30, v24, 16
; CHECK-NEXT:    vsrl.vi v24, v24, 16
; CHECK-NEXT:    vxor.vv v24, v30, v24
; CHECK-NEXT:    vadd.vv v14, v14, v24
; CHECK-NEXT:    vxor.vv v29, v29, v14
; CHECK-NEXT:    vsll.vi v30, v29, 12
; CHECK-NEXT:    vsrl.vi v29, v29, 20
; CHECK-NEXT:    vxor.vv v29, v30, v29
; CHECK-NEXT:    vadd.vv v6, v6, v29
; CHECK-NEXT:    vxor.vv v24, v24, v6
; CHECK-NEXT:    vsll.vi v30, v24, 8
; CHECK-NEXT:    vsrl.vi v24, v24, 24
; CHECK-NEXT:    vxor.vv v24, v30, v24
; CHECK-NEXT:    vadd.vv v14, v14, v24
; CHECK-NEXT:    vxor.vv v29, v29, v14
; CHECK-NEXT:    vsll.vi v30, v29, 7
; CHECK-NEXT:    vsrl.vi v29, v29, 25
; CHECK-NEXT:    vxor.vv v29, v30, v29
; CHECK-NEXT:    vadd.vv v5, v5, v28
; CHECK-NEXT:    vxor.vv v12, v12, v5
; CHECK-NEXT:    vsll.vi v30, v12, 16
; CHECK-NEXT:    vsrl.vi v12, v12, 16
; CHECK-NEXT:    vxor.vv v12, v30, v12
; CHECK-NEXT:    vadd.vv v13, v13, v12
; CHECK-NEXT:    vxor.vv v28, v28, v13
; CHECK-NEXT:    vsll.vi v30, v28, 12
; CHECK-NEXT:    vsrl.vi v28, v28, 20
; CHECK-NEXT:    vxor.vv v28, v30, v28
; CHECK-NEXT:    vadd.vv v5, v5, v28
; CHECK-NEXT:    vxor.vv v12, v12, v5
; CHECK-NEXT:    vsll.vi v30, v12, 8
; CHECK-NEXT:    vsrl.vi v12, v12, 24
; CHECK-NEXT:    vxor.vv v12, v30, v12
; CHECK-NEXT:    vadd.vv v13, v13, v12
; CHECK-NEXT:    vxor.vv v28, v28, v13
; CHECK-NEXT:    vsll.vi v30, v28, 7
; CHECK-NEXT:    vsrl.vi v28, v28, 25
; CHECK-NEXT:    vxor.vv v28, v30, v28
; CHECK-NEXT:    vadd.vv v4, v4, v27
; CHECK-NEXT:    vxor.vv v12, v12, v4
; CHECK-NEXT:    vsll.vi v30, v12, 16
; CHECK-NEXT:    vsrl.vi v12, v12, 16
; CHECK-NEXT:    vxor.vv v12, v30, v12
; CHECK-NEXT:    vadd.vv v14, v14, v12
...
; CHECK-NEXT:    vsll.vi v30, v27, 7
; CHECK-NEXT:    vsrl.vi v27, v27, 25
; CHECK-NEXT:    vxor.vv v30, v30, v27
; CHECK-NEXT:    vadd.vv v7, v7, v29
; CHECK-NEXT:    vxor.vv v15, v15, v7
; CHECK-NEXT:    vsll.vi v27, v15, 16
; CHECK-NEXT:    vsrl.vi v15, v15, 16
; CHECK-NEXT:    vxor.vv v15, v27, v15
; CHECK-NEXT:    vadd.vv v13, v13, v15
; CHECK-NEXT:    vxor.vv v27, v29, v13
; CHECK-NEXT:    vsll.vi v29, v27, 12
; CHECK-NEXT:    vsrl.vi v27, v27, 20
; CHECK-NEXT:    vxor.vv v27, v29, v27
; CHECK-NEXT:    vadd.vv v7, v7, v27
; CHECK-NEXT:    vxor.vv v15, v15, v7
; CHECK-NEXT:    vsll.vi v29, v15, 8
; CHECK-NEXT:    vsrl.vi v15, v15, 24
; CHECK-NEXT:    vxor.vv v15, v29, v15
; CHECK-NEXT:    vadd.vv v13, v13, v15
; CHECK-NEXT:    vxor.vv v27, v27, v13
; CHECK-NEXT:    vsll.vi v29, v27, 7
; CHECK-NEXT:    vsrl.vi v27, v27, 25
; CHECK-NEXT:    vxor.vv v29, v29, v27
; CHECK-NEXT:    vadd.vv v6, v6, v28
; CHECK-NEXT:    vxor.vv v25, v25, v6
; CHECK-NEXT:    vsll.vi v27, v25, 16
; CHECK-NEXT:    vsrl.vi v25, v25, 16
; CHECK-NEXT:    vxor.vv v25, v27, v25
; CHECK-NEXT:    vadd.vv v16, v16, v25
; CHECK-NEXT:    vxor.vv v27, v28, v16
; CHECK-NEXT:    vsll.vi v28, v27, 12
; CHECK-NEXT:    vsrl.vi v27, v27, 20
; CHECK-NEXT:    vxor.vv v28, v28, v27
; CHECK-NEXT:    vadd.vv v6, v6, v28
; CHECK-NEXT:    vxor.vv v25, v25, v6
; CHECK-NEXT:    vsll.vi v27, v25, 8
; CHECK-NEXT:    vsrl.vi v25, v25, 24
; CHECK-NEXT:    vxor.vv v25, v27, v25
; CHECK-NEXT:    vadd.vv v27, v16, v25
; CHECK-NEXT:    vxor.vv v16, v28, v27
; CHECK-NEXT:    vsll.vi v28, v16, 7
; CHECK-NEXT:    vsrl.vi v16, v16, 25
; CHECK-NEXT:    vxor.vv v28, v28, v16
; CHECK-NEXT:    vadd.vv v5, v5, v2
; CHECK-NEXT:    vxor.vv v16, v24, v5
; CHECK-NEXT:    vsll.vi v24, v16, 16
; CHECK-NEXT:    vsrl.vi v16, v16, 16
; CHECK-NEXT:    vxor.vv v16, v24, v16
; CHECK-NEXT:    vadd.vv v26, v26, v16
; CHECK-NEXT:    vxor.vv v2, v2, v26
; CHECK-NEXT:    vsll.vi v24, v2, 12
; CHECK-NEXT:    vsrl.vi v2, v2, 20
; CHECK-NEXT:    vxor.vv v2, v24, v2
; CHECK-NEXT:    vadd.vv v5, v5, v2
; CHECK-NEXT:    vxor.vv v16, v16, v5
; CHECK-NEXT:    vsll.vi v24, v16, 8
; CHECK-NEXT:    vsrl.vi v16, v16, 24
; CHECK-NEXT:    vxor.vv v24, v24, v16
; CHECK-NEXT:    vadd.vv v31, v26, v24
; CHECK-NEXT:    vxor.vv v2, v2, v31
; CHECK-NEXT:    vsll.vi v16, v2, 7
; CHECK-NEXT:    vsrl.vi v2, v2, 25
; CHECK-NEXT:    sext.w a3, a5
; CHECK-NEXT:    addi a5, a5, 2
; CHECK-NEXT:    vxor.vv v16, v16, v2
...
; CHECK-NEXT:    vid.v v2
; CHECK-NEXT:    vsll.vi v26, v2, 8
; CHECK-NEXT:    vsrl.vi v17, v2, 1
; CHECK-NEXT:    vrgather.vv v18, v26, v17
; CHECK-NEXT:    vadd.vi v26, v18, 8
...
; CHECK-NEXT:    vmerge.vvm v26, v18, v26, v0
; CHECK-NEXT:    vsetvli a3, s11, e32,m1,ta,mu
; CHECK-NEXT:    ld a3, -256(s0) # 8-byte Folded Reload
; CHECK-NEXT:    vadd.vx v4, v4, a3
; CHECK-NEXT:    vadd.vx v7, v7, a7
; CHECK-NEXT:    vadd.vx v18, v6, t0
; CHECK-NEXT:    vadd.vx v19, v5, t1
; CHECK-NEXT:    vsrl.vi v5, v3, 1
; CHECK-NEXT:    vsll.vi v5, v5, 1
; CHECK-NEXT:    vrgather.vv v6, v4, v5
; CHECK-NEXT:    vrgather.vv v20, v7, v5
; CHECK-NEXT:    vand.vi v3, v3, 1
; CHECK-NEXT:    vsetvli a3, zero, e32,m1,ta,mu
; CHECK-NEXT:    vand.vi v3, v3, 1
; CHECK-NEXT:    vmv.v.i v0, 0
; CHECK-NEXT:    vmsne.vv v3, v3, v0
; CHECK-NEXT:    vsetvli a3, s11, e32,m1,ta,mu
; CHECK-NEXT:    vmv1r.v v0, v3
; CHECK-NEXT:    vmerge.vvm v20, v6, v20, v0
; CHECK-NEXT:    vadd.vi v6, v5, 1
; CHECK-NEXT:    vrgather.vv v21, v4, v6
; CHECK-NEXT:    vrgather.vv v4, v7, v6
; CHECK-NEXT:    vmerge.vvm v21, v21, v4, v0
; CHECK-NEXT:    vrgather.vv v4, v18, v5
; CHECK-NEXT:    vrgather.vv v7, v19, v5
; CHECK-NEXT:    vmerge.vvm v22, v4, v7, v0
; CHECK-NEXT:    vrgather.vv v4, v18, v6
; CHECK-NEXT:    vrgather.vv v7, v19, v6
; CHECK-NEXT:    vmerge.vvm v18, v4, v7, v0
; CHECK-NEXT:    vsetvli a3, a5, e64,m1,ta,mu
; CHECK-NEXT:    vsll.vi v4, v17, 1
; CHECK-NEXT:    vrgather.vv v7, v20, v4
; CHECK-NEXT:    vlxei64.v v17, (a1), v26
; CHECK-NEXT:    vrgather.vv v19, v22, v4
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    vmerge.vvm v7, v7, v19, v0
; CHECK-NEXT:    vrgather.vv v19, v21, v4
; CHECK-NEXT:    vxor.vv v7, v7, v17
; CHECK-NEXT:    vsxei64.v v7, (a2), v26
; CHECK-NEXT:    addi a3, a1, 64
; CHECK-NEXT:    vlxei64.v v17, (a3), v26
; CHECK-NEXT:    vrgather.vv v7, v18, v4
; CHECK-NEXT:    vmerge.vvm v19, v19, v7, v0
; CHECK-NEXT:    vadd.vi v7, v4, 1
; CHECK-NEXT:    vxor.vv v17, v19, v17
; CHECK-NEXT:    addi a3, a2, 64
; CHECK-NEXT:    vsxei64.v v17, (a3), v26
; CHECK-NEXT:    addi a3, a1, 128
; CHECK-NEXT:    vlxei64.v v17, (a3), v26
; CHECK-NEXT:    vrgather.vv v19, v20, v7
; CHECK-NEXT:    vrgather.vv v20, v22, v7
; CHECK-NEXT:    vmerge.vvm v19, v19, v20, v0
; CHECK-NEXT:    vxor.vv v17, v19, v17
; CHECK-NEXT:    addi a3, a2, 128
; CHECK-NEXT:    vsxei64.v v17, (a3), v26
; CHECK-NEXT:    addi a3, a1, 192
; CHECK-NEXT:    vlxei64.v v17, (a3), v26
; CHECK-NEXT:    vrgather.vv v19, v21, v7
; CHECK-NEXT:    vrgather.vv v20, v18, v7
; CHECK-NEXT:    vmerge.vvm v18, v19, v20, v0
; CHECK-NEXT:    vxor.vv v17, v18, v17
; CHECK-NEXT:    addi a3, a2, 192
; CHECK-NEXT:    vsxei64.v v17, (a3), v26
; CHECK-NEXT:    addi a3, a1, 16
; CHECK-NEXT:    addi a4, a2, 16
; CHECK-NEXT:    vsetvli s1, s11, e32,m1,ta,mu
; CHECK-NEXT:    vadd.vx v16, v16, t2
; CHECK-NEXT:    vadd.vx v17, v30, t3
; CHECK-NEXT:    vadd.vx v18, v29, t4
; CHECK-NEXT:    vadd.vx v19, v28, t5
; CHECK-NEXT:    vrgather.vv v20, v16, v5
; CHECK-NEXT:    vrgather.vv v21, v17, v5
; CHECK-NEXT:    vmv1r.v v0, v3
; CHECK-NEXT:    vmerge.vvm v20, v20, v21, v0
; CHECK-NEXT:    vrgather.vv v21, v16, v6
; CHECK-NEXT:    vrgather.vv v16, v17, v6
; CHECK-NEXT:    vmerge.vvm v16, v21, v16, v0
; CHECK-NEXT:    vrgather.vv v17, v18, v5
; CHECK-NEXT:    vrgather.vv v21, v19, v5
; CHECK-NEXT:    vmerge.vvm v17, v17, v21, v0
; CHECK-NEXT:    vrgather.vv v21, v18, v6
; CHECK-NEXT:    vrgather.vv v18, v19, v6
; CHECK-NEXT:    vmerge.vvm v18, v21, v18, v0
; CHECK-NEXT:    vsetvli s1, a5, e64,m1,ta,mu
; CHECK-NEXT:    vlxei64.v v19, (a3), v26
; CHECK-NEXT:    vrgather.vv v21, v20, v4
; CHECK-NEXT:    vrgather.vv v22, v17, v4
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    vmerge.vvm v21, v21, v22, v0
; CHECK-NEXT:    vxor.vv v19, v21, v19
; CHECK-NEXT:    vsxei64.v v19, (a4), v26
; CHECK-NEXT:    addi a3, a1, 80
; CHECK-NEXT:    vlxei64.v v19, (a3), v26
; CHECK-NEXT:    vrgather.vv v21, v16, v4
; CHECK-NEXT:    vrgather.vv v22, v18, v4
; CHECK-NEXT:    vmerge.vvm v21, v21, v22, v0
; CHECK-NEXT:    vxor.vv v19, v21, v19
; CHECK-NEXT:    addi a3, a2, 80
; CHECK-NEXT:    vsxei64.v v19, (a3), v26
; CHECK-NEXT:    addi a3, a1, 144
; CHECK-NEXT:    vlxei64.v v19, (a3), v26
; CHECK-NEXT:    vrgather.vv v21, v20, v7
; CHECK-NEXT:    vrgather.vv v20, v17, v7
; CHECK-NEXT:    vmerge.vvm v17, v21, v20, v0
; CHECK-NEXT:    vxor.vv v17, v17, v19
; CHECK-NEXT:    addi a3, a2, 144
; CHECK-NEXT:    vsxei64.v v17, (a3), v26
; CHECK-NEXT:    addi a3, a1, 208
; CHECK-NEXT:    vlxei64.v v17, (a3), v26
; CHECK-NEXT:    vrgather.vv v19, v16, v7
; CHECK-NEXT:    vrgather.vv v16, v18, v7
; CHECK-NEXT:    vmerge.vvm v16, v19, v16, v0
; CHECK-NEXT:    vxor.vv v16, v16, v17
; CHECK-NEXT:    addi a3, a2, 208
; CHECK-NEXT:    vsxei64.v v16, (a3), v26
; CHECK-NEXT:    addi a3, a1, 32
; CHECK-NEXT:    addi a4, a2, 32
; CHECK-NEXT:    vsetvli s1, s11, e32,m1,ta,mu
; CHECK-NEXT:    vadd.vx v16, v27, t6
; CHECK-NEXT:    vadd.vx v17, v31, s2
; CHECK-NEXT:    vadd.vx v18, v14, s3
; CHECK-NEXT:    vadd.vx v19, v13, s5
; CHECK-NEXT:    vrgather.vv v20, v16, v5
; CHECK-NEXT:    vrgather.vv v21, v17, v5
; CHECK-NEXT:    vmv1r.v v0, v3
; CHECK-NEXT:    vmerge.vvm v20, v20, v21, v0
...
; CHECK-NEXT:    vsetvli s1, s11, e32,m1,ta,mu
; CHECK-NEXT:    vadd.vv v16, v15, v10
; CHECK-NEXT:    vadd.vv v17, v25, v11
; CHECK-NEXT:    vadd.vx v18, v24, s8
; CHECK-NEXT:    vadd.vx v19, v12, s9
; CHECK-NEXT:    vrgather.vv v20, v16, v5
; CHECK-NEXT:    vrgather.vv v21, v17, v5
; CHECK-NEXT:    vmv1r.v v0, v3
; CHECK-NEXT:    vmerge.vvm v20, v20, v21, v0
...
; CHECK-NEXT:    vrgather.vv v17, v18, v5
; CHECK-NEXT:    vrgather.vv v21, v19, v5
; CHECK-NEXT:    vmerge.vvm v5, v17, v21, v0
; CHECK-NEXT:    vrgather.vv v17, v18, v6
; CHECK-NEXT:    vrgather.vv v18, v19, v6
; CHECK-NEXT:    vmerge.vvm v3, v17, v18, v0
; CHECK-NEXT:    vsetvli a5, a5, e64,m1,ta,mu
; CHECK-NEXT:    vlxei64.v v6, (a3), v26
; CHECK-NEXT:    vrgather.vv v17, v20, v4
; CHECK-NEXT:    vrgather.vv v18, v5, v4
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    vmerge.vvm v17, v17, v18, v0
; CHECK-NEXT:    vxor.vv v6, v17, v6
; CHECK-NEXT:    vsxei64.v v6, (a4), v26
; CHECK-NEXT:    addi a3, a1, 112
; CHECK-NEXT:    vlxei64.v v6, (a3), v26
; CHECK-NEXT:    vrgather.vv v17, v16, v4
; CHECK-NEXT:    vrgather.vv v18, v3, v4
; CHECK-NEXT:    vmerge.vvm v4, v17, v18, v0
; CHECK-NEXT:    vxor.vv v4, v4, v6
; CHECK-NEXT:    addi a3, a2, 112
; CHECK-NEXT:    vsxei64.v v4, (a3), v26
; CHECK-NEXT:    addi a3, a1, 176
; CHECK-NEXT:    vlxei64.v v4, (a3), v26
; CHECK-NEXT:    vrgather.vv v6, v20, v7
; CHECK-NEXT:    vrgather.vv v17, v5, v7
; CHECK-NEXT:    vmerge.vvm v5, v6, v17, v0
; CHECK-NEXT:    vxor.vv v4, v5, v4
; CHECK-NEXT:    addi a3, a2, 176
; CHECK-NEXT:    vsxei64.v v4, (a3), v26
; CHECK-NEXT:    addi a3, a1, 240
; CHECK-NEXT:    vlxei64.v v4, (a3), v26
; CHECK-NEXT:    vrgather.vv v5, v16, v7
; CHECK-NEXT:    vrgather.vv v6, v3, v7
; CHECK-NEXT:    vmerge.vvm v2, v5, v6, v0
; CHECK-NEXT:    vxor.vv v2, v2, v4
; CHECK-NEXT:    addi a3, a2, 240
; CHECK-NEXT:    vsxei64.v v2, (a3), v26
...
; CHECK-NEXT:    addi sp, s0, -368
; CHECK-NEXT:    ld s11, 264(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s10, 272(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s9, 280(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s8, 288(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s7, 296(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s6, 304(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s5, 312(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s4, 320(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s3, 328(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s2, 336(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s1, 344(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld s0, 352(sp) # 8-byte Folded Reload
; CHECK-NEXT:    ld ra, 360(sp) # 8-byte Folded Reload
; CHECK-NEXT:    addi sp, sp, 368
; CHECK-NEXT:    ret
{
entry:
