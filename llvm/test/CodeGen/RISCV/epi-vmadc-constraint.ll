...
; CHECK-NEXT:    lwu s8, 124(sp)
; CHECK-NEXT:    lwu s6, 156(sp)
...
; CHECK-NEXT:    lwu s10, 132(sp)
; CHECK-NEXT:    lwu t6, 164(sp)
; CHECK-NEXT:    lwu s3, 148(sp)
