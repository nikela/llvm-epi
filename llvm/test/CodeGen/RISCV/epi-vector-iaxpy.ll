...
; CHECK-NEXT:    vle16.v v25, (t3)
; CHECK-NEXT:    add a4, a1, a5
; CHECK-NEXT:    vle16.v v26, (a4)
; CHECK-NEXT:    vmul.vx v25, v25, a3
...
; CHECK-NEXT:    vle32.v v25, (t3)
; CHECK-NEXT:    add a4, a1, a5
; CHECK-NEXT:    vle32.v v26, (a4)
; CHECK-NEXT:    vmul.vx v25, v25, a3
; CHECK-NEXT:    vadd.vv v25, v25, v26
