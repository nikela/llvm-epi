...
; CHECK-NEXT:    srli a6, a4, 1
; CHECK-NEXT:    bgeu a0, a6, .LBB0_3
; CHECK-NEXT:  # %bb.2:
; CHECK-NEXT:    li a5, 0
; CHECK-NEXT:    j .LBB0_6
...
; CHECK-NEXT:    li t0, 0
; CHECK-NEXT:    li t1, 0
; CHECK-NEXT:    remu a7, a0, a6
; CHECK-NEXT:    sub a5, a0, a7
; CHECK-NEXT:  .LBB0_4: # %vector.body
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    add t2, a2, t0
; CHECK-NEXT:    vl1re16.v v8, (t2)
; CHECK-NEXT:    add t2, a1, t0
; CHECK-NEXT:    vl1re16.v v9, (t2)
; CHECK-NEXT:    vsetvli t3, zero, e16, m1, ta, mu
; CHECK-NEXT:    vmacc.vx v9, a3, v8
; CHECK-NEXT:    vs1r.v v9, (t2)
; CHECK-NEXT:    add t1, t1, a6
; CHECK-NEXT:    add t0, t0, a4
; CHECK-NEXT:    bne t1, a5, .LBB0_4
...
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    add t2, a2, t0
; CHECK-NEXT:    vl1re32.v v8, (t2)
; CHECK-NEXT:    add t2, a1, t0
; CHECK-NEXT:    vl1re32.v v9, (t2)
; CHECK-NEXT:    vsetvli t3, zero, e32, m1, ta, mu
; CHECK-NEXT:    vmacc.vx v9, a3, v8
; CHECK-NEXT:    vs1r.v v9, (t2)
; CHECK-NEXT:    add t1, t1, a6
; CHECK-NEXT:    add t0, t0, a4
; CHECK-NEXT:    bne t1, a5, .LBB1_4
; CHECK-NEXT:  # %bb.5: # %middle.block
; CHECK-NEXT:    beqz a7, .LBB1_8
; CHECK-NEXT:  .LBB1_6: # %for.body.preheader17
; CHECK-NEXT:    sub a0, a0, a5
; CHECK-NEXT:    slli a4, a5, 2
; CHECK-NEXT:    add a1, a1, a4
; CHECK-NEXT:    add a2, a2, a4
...
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    add t2, a2, t0
; CHECK-NEXT:    vl1re64.v v8, (t2)
; CHECK-NEXT:    add t2, a1, t0
; CHECK-NEXT:    vl1re64.v v9, (t2)
; CHECK-NEXT:    vsetvli t3, zero, e64, m1, ta, mu
; CHECK-NEXT:    vmacc.vx v9, a3, v8
; CHECK-NEXT:    vs1r.v v9, (t2)
; CHECK-NEXT:    add t1, t1, a6
; CHECK-NEXT:    add t0, t0, a4
; CHECK-NEXT:    bne t1, a5, .LBB2_4
; CHECK-NEXT:  # %bb.5: # %middle.block
; CHECK-NEXT:    beqz a7, .LBB2_8
; CHECK-NEXT:  .LBB2_6: # %for.body.preheader15
; CHECK-NEXT:    sub a0, a0, a5
; CHECK-NEXT:    slli a4, a5, 3
; CHECK-NEXT:    add a1, a1, a4
; CHECK-NEXT:    add a2, a2, a4
