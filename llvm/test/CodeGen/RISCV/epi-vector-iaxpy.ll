...
; CHECK-NEXT:    srli a6, a5, 1
; CHECK-NEXT:    bgeu a0, a6, .LBB0_3
; CHECK-NEXT:  # %bb.2:
; CHECK-NEXT:    li a4, 0
; CHECK-NEXT:    j .LBB0_6
; CHECK-NEXT:  .LBB0_3: # %vector.ph
; CHECK-NEXT:    addi a4, a6, -1
; CHECK-NEXT:    and a7, a0, a4
; CHECK-NEXT:    sub a4, a0, a7
...
; CHECK-NEXT:    vl1re16.v v8, (t0)
; CHECK-NEXT:    vl1re16.v v9, (t1)
; CHECK-NEXT:    vmacc.vx v9, a3, v8
; CHECK-NEXT:    vs1r.v v9, (t1)
; CHECK-NEXT:    sub t2, t2, a6
; CHECK-NEXT:    add t1, t1, a5
; CHECK-NEXT:    add t0, t0, a5
; CHECK-NEXT:    bnez t2, .LBB0_4
