...
declare i64 @llvm.epi.vsetvlmax.ext(
  i64, i64, i64)
...
; CHECK-O2-NEXT:    ret
{
  %gvl1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
  %gvl2 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl1, i64 3, i64 0, i64 0)
  %gvl3 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl2, i64 3, i64 0, i64 0)
  %gvl4 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl3, i64 3, i64 0, i64 0)
  %gvl5 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl4, i64 3, i64 0, i64 0)
  %gvl6 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl5, i64 3, i64 0, i64 0)
  %gvl7 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl6, i64 3, i64 0, i64 0)
  %gvl8 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl7, i64 3, i64 0, i64 0)
  %gvl9 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl8, i64 3, i64 0, i64 0)
  %gvl10 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl9, i64 3, i64 0, i64 0)
...
; CHECK-O2-NEXT:    ret
{
  %gvl1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
  %gvl2 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl1, i64 3, i64 0, i64 0)
  %gvl3 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl1, i64 3, i64 0, i64 0)
  %gvl4 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl2, i64 3, i64 0, i64 0)
  %gvl5 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl2, i64 3, i64 0, i64 0)
  %gvl6 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl3, i64 3, i64 0, i64 0)
  %gvl7 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl3, i64 3, i64 0, i64 0)
  %gvl8 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl4, i64 3, i64 0, i64 0)
  %gvl9 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl4, i64 3, i64 0, i64 0)
  %gvl10 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl5, i64 3, i64 0, i64 0)
...
; CHECK-O2-NEXT:    ret
{
  %gvl1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 1, i64 0, i64 0)
  %gvl2 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 0, i64 0)
  %gvl3 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
  %gvl4 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 1, i64 0)
  %gvl5 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 2, i64 0)
  %gvl6 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 3, i64 0)
  %gvl7 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
...
; CHECK-O2-NEXT:    ret
{
  ...
  ; 1/8
  %gvl1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 0, i64 3, i64 0)

  ; 1/4
  %gvl2 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl1, i64 1, i64 3, i64 0)
  %gvl3 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl2, i64 0, i64 2, i64 0)

  ; 1/2
  %gvl4 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl3, i64 2, i64 3, i64 0)
  %gvl5 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl4, i64 1, i64 2, i64 0)
  %gvl6 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl5, i64 0, i64 1, i64 0)

  ; 1
  %gvl7 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl6, i64 3, i64 3, i64 0)
  %gvl8 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl7, i64 2, i64 2, i64 0)
  %gvl9 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl8, i64 1, i64 1, i64 0)
  %gvl10 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl9, i64 0, i64 0, i64 0)

  ; 2
  %gvl11 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl10, i64 3, i64 2, i64 0)
  %gvl12 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl11, i64 2, i64 1, i64 0)
  %gvl13 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl12, i64 1, i64 0, i64 0)

  ; 4
  %gvl14 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl13, i64 3, i64 1, i64 0)
  %gvl15 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl14, i64 2, i64 0, i64 0)

  ; 8
  %gvl16 = call i64 @llvm.epi.vsetvl.ext(i64 %gvl15, i64 3, i64 0, i64 0)
...
; CHECK-O2-NEXT:    ret
{
  call i64 @llvm.epi.vsetvl.ext(i64 0, i64 0, i64 0, i64 0)
...
; CHECK-O2-NEXT:    ret
{
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 0, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 0, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 0, i64 0, i64 0)
  call void @use(i64 %3)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 1, i64 0, i64 0)
  %5 = call i64 @llvm.epi.vsetvl.ext(i64 %4, i64 2, i64 1, i64 0)
  %6 = call i64 @llvm.epi.vsetvl.ext(i64 %4, i64 3, i64 2, i64 0)
  call void @use(i64 %5)
  call void @use(i64 %6)
  %7 = call i64 @llvm.epi.vsetvl.ext(i64 %6, i64 3, i64 1, i64 0)
  %8 = call i64 @llvm.epi.vsetvl.ext(i64 %7, i64 3, i64 0, i64 0)
  call void @use(i64 %8)
  %9 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 2, i64 0, i64 0)
  %10 = call i64 @llvm.epi.vsetvl.ext(i64 %9, i64 1, i64 0, i64 0)
...
; CHECK-O2-NEXT:    ret
{
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 0, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 1, i64 0, i64 0)
  call void @use(i64 %3)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 1, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 0, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 2, i64 0, i64 0)
  call void @use(i64 %3)
  ret void
}
...
{
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 1, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 0, i64 0, i64 0)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %3, i64 2, i64 0, i64 0)
  call void @use(i64 %4)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 1, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 1, i64 1, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 0, i64 1, i64 0)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %3, i64 2, i64 0, i64 0)
  call void @use(i64 %4)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 2, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 1, i64 0, i64 0)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %3, i64 0, i64 0, i64 0)
  %5 = call i64 @llvm.epi.vsetvl.ext(i64 %4, i64 0, i64 0, i64 0)
  %6 = call i64 @llvm.epi.vsetvl.ext(i64 %5, i64 1, i64 0, i64 0)
  %7 = call i64 @llvm.epi.vsetvl.ext(i64 %6, i64 2, i64 0, i64 0)
  %8 = call i64 @llvm.epi.vsetvl.ext(i64 %7, i64 3, i64 0, i64 0)
  call void @use(i64 %8)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  ...
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 0, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 1, i64 0, i64 0)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %3, i64 3, i64 0, i64 0)
  %5 = call i64 @llvm.epi.vsetvl.ext(i64 %4, i64 2, i64 0, i64 0)
  call void @use(i64 %5)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  ...
  %1 = call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 0, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 3, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 3, i64 1, i64 0)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %3, i64 2, i64 1, i64 0)
  %5 = call i64 @llvm.epi.vsetvl.ext(i64 %4, i64 1, i64 1, i64 0)
  call void @use(i64 %5)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  ...
  %3 = call i64 @llvm.epi.vsetvl.ext(i64 %2, i64 1, i64 0, i64 0)
  call void @use(i64 %3)
  %4 = call i64 @llvm.epi.vsetvl.ext(i64 %1, i64 1, i64 1, i64 0)
  %5 = call i64 @llvm.epi.vsetvl.ext(i64 %4, i64 0, i64 1, i64 0)
  %6 = call i64 @llvm.epi.vsetvl.ext(i64 %5, i64 0, i64 2, i64 0)
  call void @use(i64 %6)
  ret void
}
...
; CHECK-O2-NEXT:    ret
{
  %1 = call i64 @llvm.epi.vsetvlmax.ext(i64 0, i64 0, i64 0)
  %2 = call i64 @llvm.epi.vsetvlmax.ext(i64 1, i64 0, i64 0)
  %3 = call i64 @llvm.epi.vsetvlmax.ext(i64 1, i64 0, i64 0)
  %4 = call i64 @llvm.epi.vsetvlmax.ext(i64 0, i64 0, i64 0)
  ret i64 %4
}
