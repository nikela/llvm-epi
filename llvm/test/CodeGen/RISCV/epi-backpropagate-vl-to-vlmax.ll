...
; ENABLED:       # %bb.0:
; ENABLED-NEXT:    vsetvli zero, a0, e64,m1,tu,mu
; ENABLED-NEXT:    vadd.vv v1, v16, v17
; ENABLED-NEXT:    vadd.vv v16, v1, v18
; ENABLED-NEXT:    ret
;
; DISABLED-LABEL: test.1:
; DISABLED:       # %bb.0:
; DISABLED-NEXT:    vsetvli a1, zero, e64,m1,tu,mu
; DISABLED-NEXT:    vadd.vv v1, v16, v17
; DISABLED-NEXT:    vsetvli a0, a0, e64,m1,tu,mu
; DISABLED-NEXT:    vadd.vv v16, v1, v18
; DISABLED-NEXT:    ret
{
...
; ENABLED:       # %bb.0:
; ENABLED-NEXT:    vsetvli a1, zero, e64,m1,tu,mu
; ENABLED-NEXT:    vadd.vv v1, v16, v17
