...
; CHECK-NEXT:    vlxseg5ei64.v v16, (a0), v16
...
; CHECK-NEXT:    vsxseg5ei64.v v16, (a0), v21
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vlxseg5ei32.v v16, (a0), v16
; CHECK-NEXT:    # kill: def $v16 killed $v16 killed $v16_v17_v18_v19_v20
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a1, a1, e32,m1,ta,mu
; CHECK-NEXT:    # kill: def $v16 killed $v16 killed $v16_v17_v18_v19_v20 def $v16_v17_v18_v19_v20
; CHECK-NEXT:    vsxseg5ei32.v v16, (a0), v21
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vlxseg5ei16.v v16, (a0), v16
; CHECK-NEXT:    # kill: def $v16 killed $v16 killed $v16_v17_v18_v19_v20
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a1, a1, e16,m1,ta,mu
; CHECK-NEXT:    # kill: def $v16 killed $v16 killed $v16_v17_v18_v19_v20 def $v16_v17_v18_v19_v20
; CHECK-NEXT:    vsxseg5ei16.v v16, (a0), v21
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vlxseg5ei8.v v16, (a0), v16
; CHECK-NEXT:    # kill: def $v16 killed $v16 killed $v16_v17_v18_v19_v20
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a1, a1, e8,m1,ta,mu
; CHECK-NEXT:    # kill: def $v16 killed $v16 killed $v16_v17_v18_v19_v20 def $v16_v17_v18_v19_v20
; CHECK-NEXT:    vsxseg5ei8.v v16, (a0), v21
; CHECK-NEXT:    ret
