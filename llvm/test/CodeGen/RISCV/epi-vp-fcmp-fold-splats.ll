...
; CHECK-O0-NEXT:    vmfgt.vf v25, v16, fa0, v0.t
...
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vmflt.vf v25, v16, fa0, v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O0-NEXT:    vse8.v v25, (a0)
; CHECK-O0-NEXT:    vsetvli zero, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vmfge.vf v25, v16, fa0, v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O0-NEXT:    vse8.v v25, (a0)
; CHECK-O0-NEXT:    vsetvli zero, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vmfle.vf v25, v16, fa0, v0.t
...
; CHECK-O2-NEXT:    vmfgt.vf v25, v16, fa0, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    vsetvli zero, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmflt.vf v25, v16, fa0, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    vsetvli zero, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmfge.vf v25, v16, fa0, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    vsetvli zero, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmfle.vf v25, v16, fa0, v0.t
...
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vsetvli a2, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    vmflt.vf v25, v16, ft0, v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O0-NEXT:    vse8.v v25, (a0)
; CHECK-O0-NEXT:    vsetvli zero, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vmfgt.vf v25, v16, ft0, v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O0-NEXT:    vse8.v v25, (a0)
; CHECK-O0-NEXT:    vsetvli zero, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vmfle.vf v25, v16, ft0, v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O0-NEXT:    vse8.v v25, (a0)
; CHECK-O0-NEXT:    vsetvli zero, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vmfge.vf v25, v16, ft0, v0.t
; CHECK-O0-NEXT:    vsetvli a1, zero, e8,m1,ta,mu
; CHECK-O0-NEXT:    vse8.v v25, (a0)
; CHECK-O0-NEXT:    addi sp, s0, -48
; CHECK-O0-NEXT:    ld s0, 32(sp) # 8-byte Folded Reload
...
; CHECK-O2-NEXT:    addi a1, a1, %lo(scratch)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmflt.vf v25, v16, ft0, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    vsetvli zero, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmfgt.vf v25, v16, ft0, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    vsetvli zero, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmfle.vf v25, v16, ft0, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    vsetvli zero, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmfge.vf v25, v16, ft0, v0.t
; CHECK-O2-NEXT:    vsetvli a0, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vse8.v v25, (a1)
; CHECK-O2-NEXT:    ret
  %store_addr = bitcast i8* @scratch to <vscale x 1 x i1>*
