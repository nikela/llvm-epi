...
; RV32MV-NEXT:    vsetvli zero, zero, e32, m2, tu, mu
...
; RV64MV-NEXT:    sd a1, 24(sp)
; RV64MV-NEXT:    vsetivli zero, 4, e64, m2, ta, mu
; RV64MV-NEXT:    addi a1, sp, 16
...
; RV64MV-NEXT:    vsetivli zero, 1, e64, m2, tu, mu
