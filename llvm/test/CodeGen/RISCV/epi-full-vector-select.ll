...
; CHECK-O0-NEXT:    vmerge.vvm v25, v17, v16, v0
...
; CHECK-O2-NEXT:    vmerge.vvm v25, v17, v16, v0
...
; CHECK-O0-NEXT:    vmerge.vvm v26, v18, v16, v0
...
; CHECK-O2-NEXT:    vmerge.vvm v26, v18, v16, v0
...
; CHECK-O0-NEXT:    # implicit-def: $v16m8
; CHECK-O0-NEXT:    vsetvli a1, zero, e64,m8,ta,mu
; CHECK-O0-NEXT:    vle64.v v16, (a0)
...
; CHECK-O0-NEXT:    vmv.v.x v0, a1
; CHECK-O0-NEXT:    vsetvli a1, zero, e64,m8,ta,mu
; CHECK-O0-NEXT:    vmerge.vvm v8, v16, v24, v0
; CHECK-O0-NEXT:    vse64.v v8, (a0)
; CHECK-O0-NEXT:    ret
;
; CHECK-O2-LABEL: test_select_scalar_int_4:
; CHECK-O2:       # %bb.0:
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m8,ta,mu
...
; CHECK-O2-NEXT:    vsetvli a1, zero, e64,m8,ta,mu
...
; CHECK-O2:       # %bb.0:
; CHECK-O2-NEXT:    vsetvli a2, zero, e32,m8,ta,mu
...
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vmv.v.x v0, a1
; CHECK-O2-NEXT:    vsetvli a1, zero, e32,m8,ta,mu
; CHECK-O2-NEXT:    vmerge.vvm v24, v8, v16, v0
...
; CHECK-O2:       # %bb.0:
; CHECK-O2-NEXT:    vsetvli a2, zero, e16,m8,ta,mu
...
; CHECK-O2-NEXT:    vsetvli a2, zero, e8,m1,ta,mu
; CHECK-O2-NEXT:    vmv.v.x v0, a1
; CHECK-O2-NEXT:    vsetvli a1, zero, e16,m8,ta,mu
; CHECK-O2-NEXT:    vmerge.vvm v24, v8, v16, v0
