...
; CHECK-O2-NEXT:    sd s1, 16(sp) # 8-byte Folded Spill
; CHECK-O2-NEXT:    sd s2, 8(sp) # 8-byte Folded Spill
; CHECK-O2-NEXT:    mv s1, a0
; CHECK-O2-NEXT:    vsetvli a0, a0, e8,m1,tu,mu
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    vsetvli s2, s1, e16,m1,tu,mu
; CHECK-O2-NEXT:    mv a0, s2
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    mv a0, s2
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    vsetvli s2, s1, e64,m2,tu,mu
; CHECK-O2-NEXT:    vsetvli a0, s1, e64,m1,tu,mu
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    mv a0, s2
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    ld s2, 8(sp) # 8-byte Folded Reload
; CHECK-O2-NEXT:    ld s1, 16(sp) # 8-byte Folded Reload
...
; CHECK-O2-NEXT:    addi sp, sp, -16
; CHECK-O2-NEXT:    sd ra, 8(sp) # 8-byte Folded Spill
; CHECK-O2-NEXT:    sd s1, 0(sp) # 8-byte Folded Spill
; CHECK-O2-NEXT:    vsetvli s1, a0, e64,m1,tu,mu
; CHECK-O2-NEXT:    mv a0, s1
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    mv a0, s1
; CHECK-O2-NEXT:    call use@plt
; CHECK-O2-NEXT:    ld s1, 0(sp) # 8-byte Folded Reload
; CHECK-O2-NEXT:    ld ra, 8(sp) # 8-byte Folded Reload
; CHECK-O2-NEXT:    addi sp, sp, 16
; CHECK-O2-NEXT:    ret
{
