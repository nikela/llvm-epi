...
; CHECK-NEXT:    call __epi_exp_nxv1f64
...
; CHECK-NEXT:    call __epi_exp_nxv2f64
; CHECK-NEXT:    ld ra, 8(sp)
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    call __epi_exp_nxv4f64
; CHECK-NEXT:    ld ra, 8(sp)
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    sd ra, 8(sp)
; CHECK-NEXT:    vmv1r.v v16, v17
; CHECK-NEXT:    call __epi_exp_nxv2f32
; CHECK-NEXT:    ld ra, 8(sp)
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    sd ra, 8(sp)
; CHECK-NEXT:    vmv2r.v v16, v18
; CHECK-NEXT:    call __epi_exp_nxv4f32
; CHECK-NEXT:    ld ra, 8(sp)
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    sd ra, 8(sp)
; CHECK-NEXT:    vmv4r.v v16, v20
; CHECK-NEXT:    call __epi_exp_nxv8f32
; CHECK-NEXT:    ld ra, 8(sp)
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
