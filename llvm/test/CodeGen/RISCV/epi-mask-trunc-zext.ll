...
; CHECK-NEXT:    vmsne.vv v25, v25, v26
; CHECK-NEXT:    vand.vi v27, v17, 1
; CHECK-NEXT:    vmsne.vv v26, v27, v26
...
; CHECK-NEXT:    vmsne.vv v30, v26, v28
; CHECK-NEXT:    vmand.mm v0, v25, v30
; CHECK-NEXT:    ret
{
...
; CHECK-NEXT:    vand.vv v16, v28, v30
; CHECK-NEXT:    ret
{
