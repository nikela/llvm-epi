...
; RUN: llc -mtriple=riscv64 -mattr=+d,+v -verify-machineinstrs -epi-pipeline \
; RUN:    < %s | FileCheck %s

define void @epi_propagate_AVL(i64 %N, double* %c, double* %a, double* %b) nounwind {
