...
define <vscale x 4 x float> @test_vp_sitofp_nxv4f32_nxv4i8(<vscale x 4 x i8> %a, i32 %evl) {
...
define <vscale x 4 x double> @test_vp_sitofp_nxv4f64_nxv4i8(<vscale x 4 x i8> %a, i32 %evl) {
...
define <vscale x 4 x double> @test_vp_sitofp_nxv4f64_nxv4i16(<vscale x 4 x i16> %a, i32 %evl) {
