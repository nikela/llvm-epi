...
; CHECK-O0-NEXT:    vle64.v v22, (a2), v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    # implicit-def: $v23
; CHECK-O0-NEXT:    vle64.v v23, (a1), v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v21
; CHECK-O0-NEXT:    vadd.vv v21, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v20
; CHECK-O0-NEXT:    vsub.vv v20, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v19
; CHECK-O0-NEXT:    vmul.vv v19, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v18
; CHECK-O0-NEXT:    vdiv.vv v18, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v17
; CHECK-O0-NEXT:    vrem.vv v17, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v16
; CHECK-O0-NEXT:    vdivu.vv v16, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v7
; CHECK-O0-NEXT:    vremu.vv v7, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v6
; CHECK-O0-NEXT:    vand.vv v6, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v5
; CHECK-O0-NEXT:    vor.vv v5, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v4
; CHECK-O0-NEXT:    vxor.vv v4, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v3
; CHECK-O0-NEXT:    vsra.vv v3, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v2
; CHECK-O0-NEXT:    vsrl.vv v2, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v1
; CHECK-O0-NEXT:    vsll.vv v1, v22, v23, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    vse64.v v21, (a0), v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
...
; CHECK-O0-NEXT:    vle32.v v22, (a2)
; CHECK-O0-NEXT:    # implicit-def: $v23
; CHECK-O0-NEXT:    vle32.v v23, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v21
; CHECK-O0-NEXT:    vadd.vv v21, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v20
; CHECK-O0-NEXT:    vsub.vv v20, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v19
; CHECK-O0-NEXT:    vmul.vv v19, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v18
; CHECK-O0-NEXT:    vdiv.vv v18, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v17
; CHECK-O0-NEXT:    vrem.vv v17, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v16
; CHECK-O0-NEXT:    vdivu.vv v16, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v7
; CHECK-O0-NEXT:    vremu.vv v7, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v6
; CHECK-O0-NEXT:    vand.vv v6, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v5
; CHECK-O0-NEXT:    vor.vv v5, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v4
; CHECK-O0-NEXT:    vxor.vv v4, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v3
; CHECK-O0-NEXT:    vsra.vv v3, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v2
; CHECK-O0-NEXT:    vsrl.vv v2, v22, v23
; CHECK-O0-NEXT:    # implicit-def: $v1
; CHECK-O0-NEXT:    vsll.vv v1, v22, v23
; CHECK-O0-NEXT:    vse32.v v21, (a0)
...
; CHECK-O0-NEXT:    vsetvli a3, a3, e64,m2,tu,mu
; CHECK-O0-NEXT:    vle64.v v28, (a2), v0.t
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    # implicit-def: $v30m2
; CHECK-O0-NEXT:    vle64.v v30, (a1), v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v26m2
; CHECK-O0-NEXT:    vadd.vv v26, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v24m2
; CHECK-O0-NEXT:    vsub.vv v24, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v14m2
; CHECK-O0-NEXT:    vmul.vv v14, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v12m2
; CHECK-O0-NEXT:    vdiv.vv v12, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v10m2
; CHECK-O0-NEXT:    vrem.vv v10, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v8m2
; CHECK-O0-NEXT:    vdivu.vv v8, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v22m2
; CHECK-O0-NEXT:    vremu.vv v22, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v20m2
; CHECK-O0-NEXT:    vand.vv v20, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v18m2
; CHECK-O0-NEXT:    vor.vv v18, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v16m2
; CHECK-O0-NEXT:    vxor.vv v16, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v6m2
; CHECK-O0-NEXT:    vsra.vv v6, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v4m2
; CHECK-O0-NEXT:    vsrl.vv v4, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v2m2
; CHECK-O0-NEXT:    vsll.vv v2, v28, v30, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
