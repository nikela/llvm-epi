...
; CHECK-O0-NEXT:    vmcpy.m v2, v3
; CHECK-O0-NEXT:    vmcpy.m v3, v4
; CHECK-O0-NEXT:    vmcpy.m v1, v1
; CHECK-O0-NEXT:    vsetvli a0, a2, e64,m1
; CHECK-O0-NEXT:    vse.v v2, (a3)
...
; CHECK-O2-NEXT:    vmcpy.m v2, v3
; CHECK-O2-NEXT:    vmcpy.m v3, v4
; CHECK-O2-NEXT:    vmcpy.m v1, v1
...
; CHECK-O0-NEXT:    vmor.mm v4, v1, v2
; CHECK-O0-NEXT:    vmxor.mm v1, v1, v2
; CHECK-O0-NEXT:    vsetvli a0, zero, e16,m1
; CHECK-O0-NEXT:    vmcpy.m v2, v3
; CHECK-O0-NEXT:    vmcpy.m v3, v4
; CHECK-O0-NEXT:    vmcpy.m v1, v1
; CHECK-O0-NEXT:    vsetvli a0, a2, e16,m1
; CHECK-O0-NEXT:    vse.v v2, (a3)
; CHECK-O0-NEXT:    vse.v v3, (a3)
; CHECK-O0-NEXT:    vse.v v1, (a3)
; CHECK-O0-NEXT:    ret
...
; CHECK-O2:       # %bb.0:
; CHECK-O2-NEXT:    vsetvli a3, a2, e16,m1
; CHECK-O2-NEXT:    vle.v v1, (a0)
; CHECK-O2-NEXT:    vle.v v2, (a1)
; CHECK-O2-NEXT:    lui a0, %hi(scratch)
; CHECK-O2-NEXT:    addi a0, a0, %lo(scratch)
...
; CHECK-O2-NEXT:    vmor.mm v4, v1, v2
; CHECK-O2-NEXT:    vmxor.mm v1, v1, v2
; CHECK-O2-NEXT:    vsetvli a1, zero, e16,m1
; CHECK-O2-NEXT:    vmcpy.m v2, v3
; CHECK-O2-NEXT:    vmcpy.m v3, v4
; CHECK-O2-NEXT:    vmcpy.m v1, v1
; CHECK-O2-NEXT:    vsetvli a1, a2, e16,m1
; CHECK-O2-NEXT:    vse.v v2, (a0)
; CHECK-O2-NEXT:    vse.v v3, (a0)
; CHECK-O2-NEXT:    vse.v v1, (a0)
; CHECK-O2-NEXT:    ret
...
; CHECK-O0-NEXT:    vmcpy.m v3, v4
; CHECK-O0-NEXT:    vmcpy.m v1, v1
; CHECK-O0-NEXT:    vsetvli a0, a2, e8,m1
; CHECK-O0-NEXT:    vse.v v2, (a3)
; CHECK-O0-NEXT:    vse.v v3, (a3)
; CHECK-O0-NEXT:    vse.v v1, (a3)
; CHECK-O0-NEXT:    ret
...
; CHECK-O2:       # %bb.0:
; CHECK-O2-NEXT:    vsetvli a3, a2, e8,m1
; CHECK-O2-NEXT:    vle.v v1, (a0)
; CHECK-O2-NEXT:    vle.v v2, (a1)
; CHECK-O2-NEXT:    lui a0, %hi(scratch)
; CHECK-O2-NEXT:    addi a0, a0, %lo(scratch)
...
; CHECK-O2-NEXT:    vmor.mm v4, v1, v2
; CHECK-O2-NEXT:    vmxor.mm v1, v1, v2
; CHECK-O2-NEXT:    vsetvli a1, zero, e8,m1
; CHECK-O2-NEXT:    vmcpy.m v2, v3
; CHECK-O2-NEXT:    vmcpy.m v3, v4
; CHECK-O2-NEXT:    vmcpy.m v1, v1
; CHECK-O2-NEXT:    vsetvli a1, a2, e8,m1
; CHECK-O2-NEXT:    vse.v v2, (a0)
; CHECK-O2-NEXT:    vse.v v3, (a0)
; CHECK-O2-NEXT:    vse.v v1, (a0)
; CHECK-O2-NEXT:    ret
...
; CHECK-O2-NEXT:    vsetvli a4, a2, e8,m2
; CHECK-O2-NEXT:    vle.v v2, (a0)
; CHECK-O2-NEXT:    addi a0, a3, %lo(scratch)
; CHECK-O2-NEXT:    vle.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a1, zero, e8,m2
...
; CHECK-O2-NEXT:    vsetvli a1, a2, e8,m2
...
; CHECK-O0-NEXT:    vse.v v8, (a3)
; CHECK-O0-NEXT:    ret
;
; CHECK-O2-LABEL: test_vp_logical_6:
; CHECK-O2:       # %bb.0:
; CHECK-O2-NEXT:    lui a3, %hi(scratch)
; CHECK-O2-NEXT:    vsetvli a4, a2, e8,m4
; CHECK-O2-NEXT:    vle.v v4, (a0)
; CHECK-O2-NEXT:    addi a0, a3, %lo(scratch)
; CHECK-O2-NEXT:    vle.v v16, (a1)
; CHECK-O2-NEXT:    vsetvli a1, zero, e8,m4
...
; CHECK-O2-NEXT:    vsetvli a1, a2, e8,m4
; CHECK-O2-NEXT:    vmand.mm v0, v2, v3
; CHECK-O2-NEXT:    vmor.mm v1, v2, v3
; CHECK-O2-NEXT:    vmxor.mm v2, v2, v3
; CHECK-O2-NEXT:    vsetvli a1, zero, e8,m4
