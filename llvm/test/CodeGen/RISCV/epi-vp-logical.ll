...
; CHECK-O0-NEXT:    vmsne.vi v27, v25, 0
...
; CHECK-O2-NEXT:    vmerge.vim v27, v28, 1, v0
; CHECK-O2-NEXT:    vmv1r.v v0, v25
; CHECK-O2-NEXT:    vmerge.vim v25, v28, 1, v0
; CHECK-O2-NEXT:    vmv1r.v v0, v26
; CHECK-O2-NEXT:    vmerge.vim v26, v28, 1, v0
; CHECK-O2-NEXT:    vse64.v v27, (a0)
...
; CHECK-O0-NEXT:    vmsne.vi v28, v26, 0
; CHECK-O0-NEXT:    vmv.v.i v26, 0
; CHECK-O0-NEXT:    vmand.mm v0, v25, v28
; CHECK-O0-NEXT:    vmor.mm v29, v25, v28
; CHECK-O0-NEXT:    ld a1, -48(s0)
; CHECK-O0-NEXT:    vs1r.v v29, (a1)
; CHECK-O0-NEXT:    vmxor.mm v25, v25, v28
; CHECK-O0-NEXT:    ld a1, -40(s0)
...
; CHECK-O0-NEXT:    vle8.v v8, (a2)
; CHECK-O0-NEXT:    # implicit-def: $v28m4
; CHECK-O0-NEXT:    vle8.v v28, (a1)
