...
; CHECK-O0-NEXT:    vsetvli zero, a2, e8, m2, ta, mu
; CHECK-O0-NEXT:    vle8.v v28, (a3)
; CHECK-O0-NEXT:    # implicit-def: $v26m2
; CHECK-O0-NEXT:    vle8.v v26, (a1)
; CHECK-O0-NEXT:    vsetvli a1, zero, e8, m2, ta, mu
