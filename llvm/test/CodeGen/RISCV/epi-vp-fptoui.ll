...
define <vscale x 4 x i8> @test_vp_fptoui_nxv4i8_nxv4f32(<vscale x 4 x float> %a, i32 %evl) {
...
define <vscale x 4 x i8> @test_vp_fptoui_nxv4i8_nxv4f64(<vscale x 4 x double> %a, i32 %evl) {
...
define <vscale x 4 x i16> @test_vp_fptoui_nxv4i16_nxv4f64(<vscale x 4 x double> %a, i32 %evl) {
