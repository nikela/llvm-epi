...
; CHECK-O0-NEXT:    vmseq.vv v0, v16, v18, v0.t
...
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmsne.vv v0, v16, v18, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmsleu.vv v0, v18, v16, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmsltu.vv v0, v18, v16, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmsltu.vv v0, v16, v18, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmsleu.vv v0, v16, v18, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmsle.vv v0, v18, v16, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmslt.vv v0, v18, v16, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a2)
; CHECK-O0-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O0-NEXT:    vmslt.vv v0, v16, v18, v0.t
; CHECK-O0-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O0-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O0-NEXT:    vse.v v4, (a1)
; CHECK-O0-NEXT:    ld a2, -40(s0)
...
; CHECK-O0-NEXT:    vmsle.vv v0, v16, v18, v0.t
...
; CHECK-O2-NEXT:    vmseq.vv v0, v16, v18, v0.t
...
; CHECK-O2-NEXT:    vmsne.vv v0, v16, v18, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmsleu.vv v0, v18, v16, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmsltu.vv v0, v18, v16, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmsltu.vv v0, v16, v18, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmsleu.vv v0, v16, v18, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmsle.vv v0, v18, v16, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmslt.vv v0, v18, v16, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a2, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmslt.vv v0, v16, v18, v0.t
; CHECK-O2-NEXT:    vsetvli a2, zero, e64,m2
; CHECK-O2-NEXT:    vmerge.vim v4, v2, 1, v0
; CHECK-O2-NEXT:    vse.v v4, (a1)
; CHECK-O2-NEXT:    vsetvli a0, a0, e64,m2
; CHECK-O2-NEXT:    vmv1r.v v0, v1
; CHECK-O2-NEXT:    vmsle.vv v0, v16, v18, v0.t
