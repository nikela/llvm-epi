...
; CHECK-NEXT:    add a1, s3, a1
; CHECK-NEXT:    vsuxei64.v v10, (a1), v25
...
; CHECK-NEXT:    vsuxei64.v v9, (a1), v25
...
; CHECK-NEXT:    vsuxei64.v v8, (a0), v25
; CHECK-NEXT:    vsuxei64.v v25, (a0), v25
...
; CHECK-NEXT:    vsuxei64.v v27, (a0), v25
entry:
