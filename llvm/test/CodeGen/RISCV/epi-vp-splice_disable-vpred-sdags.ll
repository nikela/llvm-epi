...
; RUN: llc -mtriple riscv64 -mattr=+f,+d,+experimental-v -verify-machineinstrs -epi-pipeline -disable-vpred-sdags \
; RUN:   < %s | FileCheck %s
...
; CHECK-NEXT:    vmslt.vx v12, v14, a2, v0.t
...
; CHECK-NEXT:    vsetvli zero, a1, e64, m1, ta, mu
; CHECK-NEXT:    vid.v v10
; CHECK-NEXT:    vmslt.vx v10, v10, a2, v0.t
