...
; CHECK-O0-NEXT:    addi a0, a0, %lo(scratch)
; CHECK-O0-NEXT:    vsetvli a1, a1, e64,m1,ta,mu
; CHECK-O0-NEXT:    vmxor.mm v25, v16, v0
; CHECK-O0-NEXT:    vmand.mm v25, v25, v17
; CHECK-O0-NEXT:    vmxor.mm v25, v16, v25
...
; CHECK-O2-NEXT:    addi a1, a1, %lo(scratch)
; CHECK-O2-NEXT:    vsetvli a0, a0, e64,m1,ta,mu
; CHECK-O2-NEXT:    vmxor.mm v25, v16, v0
; CHECK-O2-NEXT:    vmand.mm v25, v25, v17
; CHECK-O2-NEXT:    vmxor.mm v25, v16, v25
