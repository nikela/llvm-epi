...
; CHECK-NEXT:    ret
entry:
  %0 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
...
if.else:                                          ; preds = %entry
  %2 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
...
if.else:                                          ; preds = %entry
  %5 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 0, i64 0)
...
if.end:                                           ; preds = %if.else, %if.then
  %10 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
...
if.then4:                                         ; preds = %if.end
  %3 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 3, i64 0, i64 0)
...
if.else5:                                         ; preds = %if.end
  %8 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 0, i64 0)
...
; CHECK-NEXT:    vsetvli zero, a1, e64,m1,ta,mu
; CHECK-NEXT:    vfadd.vv v8, v8, v9
; CHECK-NEXT:    lui a2, %hi(.LCPI7_0)
; CHECK-NEXT:    flw ft0, %lo(.LCPI7_0)(a2)
; CHECK-NEXT:    lui a2, %hi(scratch)
; CHECK-NEXT:    addi a2, a2, %lo(scratch)
; CHECK-NEXT:    fmv.w.x ft2, zero
; CHECK-NEXT:    j .LBB7_2
; CHECK-NEXT:  .LBB7_1: # %do.cond
; CHECK-NEXT:    # in Loop: Header=BB7_2 Depth=1
; CHECK-NEXT:    feq.s a3, ft1, ft2
; CHECK-NEXT:    bnez a3, .LBB7_4
; CHECK-NEXT:  .LBB7_2: # %do.body
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    flt.s a3, ft0, ft1
; CHECK-NEXT:    beqz a3, .LBB7_1
...
if.then:                                          ; preds = %do.body
  ...
  %3 = tail call i64 @llvm.epi.vsetvl.ext(i64 %avl, i64 2, i64 0, i64 0)
