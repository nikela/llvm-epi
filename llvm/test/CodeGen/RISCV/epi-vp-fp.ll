...
; CHECK-O0-NEXT:    vsetvli a4, a4, e64,m1,tu,mu
...
; CHECK-O0-NEXT:    vle64.v v3, (a2), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    # implicit-def: $v4
; CHECK-O0-NEXT:    vle64.v v4, (a3), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
...
; CHECK-O0-NEXT:    vfmadd.vv v17, v2, v3, v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    # implicit-def: $v2
...
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    # implicit-def: $v1
; CHECK-O0-NEXT:    vfcvt.f.x.v v1, v4, v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v5, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v6, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v7, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v16, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v17, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v2, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v1, (a5), v0.t
...
; CHECK-O0-NEXT:    addi a5, a5, %lo(scratch)
; CHECK-O0-NEXT:    # implicit-def: $v1
; CHECK-O0-NEXT:    vsetvli a4, a4, e32,m1,tu,mu
; CHECK-O0-NEXT:    vle32.v v1, (a0)
; CHECK-O0-NEXT:    # implicit-def: $v2
; CHECK-O0-NEXT:    vle32.v v2, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v3
; CHECK-O0-NEXT:    vle32.v v3, (a2)
; CHECK-O0-NEXT:    # implicit-def: $v4
; CHECK-O0-NEXT:    vle32.v v4, (a3)
; CHECK-O0-NEXT:    # implicit-def: $v5
...
; CHECK-O0-NEXT:    vmv1r.v v17, v1
; CHECK-O0-NEXT:    vfmadd.vv v17, v2, v3
; CHECK-O0-NEXT:    # implicit-def: $v2
; CHECK-O0-NEXT:    vfsgnjn.vv v2, v1, v1
; CHECK-O0-NEXT:    # implicit-def: $v1
; CHECK-O0-NEXT:    vfcvt.f.x.v v1, v4
; CHECK-O0-NEXT:    vse32.v v5, (a5)
; CHECK-O0-NEXT:    vse32.v v6, (a5)
; CHECK-O0-NEXT:    vse32.v v7, (a5)
; CHECK-O0-NEXT:    vse32.v v16, (a5)
; CHECK-O0-NEXT:    vse32.v v17, (a5)
; CHECK-O0-NEXT:    vse32.v v2, (a5)
; CHECK-O0-NEXT:    vse32.v v1, (a5)
; CHECK-O0-NEXT:    ret
;
...
; CHECK-O0-NEXT:    vsetvli a4, a4, e64,m2,tu,mu
...
; CHECK-O0-NEXT:    vle64.v v6, (a2), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
...
; CHECK-O0-NEXT:    vfmadd.vv v10, v4, v6, v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    # implicit-def: $v4m2
...
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v18, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v20, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v22, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v8, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v10, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v4, (a5), v0.t
; CHECK-O0-NEXT:    ld a0, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a0)
; CHECK-O0-NEXT:    vse64.v v2, (a5), v0.t
; CHECK-O0-NEXT:    addi sp, s0, -48
