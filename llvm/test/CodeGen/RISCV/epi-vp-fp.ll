...
; CHECK-O0-NEXT:    vle64.v v9, (a2), v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
...
; CHECK-O0-NEXT:    vfsub.vv v30, v25, v26, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v29
; CHECK-O0-NEXT:    vfmul.vv v29, v25, v26, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
...
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v25
; CHECK-O0-NEXT:    vfcvt.f.x.v v25, v8, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
...
; CHECK-O0-NEXT:    vle64.v v18, (a2), v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
...
; CHECK-O0-NEXT:    vfsub.vv v12, v26, v28, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v10m2
; CHECK-O0-NEXT:    vfmul.vv v10, v26, v28, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
...
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
; CHECK-O0-NEXT:    # implicit-def: $v26m2
; CHECK-O0-NEXT:    vfcvt.f.x.v v26, v16, v0.t
; CHECK-O0-NEXT:    ld a1, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a1)
