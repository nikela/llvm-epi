...
; CHECK-O0-NEXT:    vle64.v v1, (a5), v0.t
; CHECK-O0-NEXT:    ld a5, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a5)
; CHECK-O0-NEXT:    # implicit-def: $v2
; CHECK-O0-NEXT:    vsetvli a5, a4, e64,m1,ta,mu
...
; CHECK-O0-NEXT:    vle32.v v1, (a5)
; CHECK-O0-NEXT:    # implicit-def: $v2
; CHECK-O0-NEXT:    vsetvli a5, a4, e32,m1,ta,mu
...
; CHECK-O0-NEXT:    vle64.v v2, (a5), v0.t
; CHECK-O0-NEXT:    ld a5, -40(s0)
; CHECK-O0-NEXT:    vl1r.v v0, (a5)
; CHECK-O0-NEXT:    # implicit-def: $v4m2
; CHECK-O0-NEXT:    vsetvli a5, a4, e64,m2,ta,mu
