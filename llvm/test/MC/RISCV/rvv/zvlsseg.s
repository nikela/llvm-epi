...
# RUN: llvm-mc -triple=riscv64 -filetype=obj --mattr=+experimental-v,experimental-zvlsseg %s \
# RUN:        | llvm-objdump -d --mattr=+experimental-v,experimental-zvlsseg - \
# RUN:        | FileCheck %s --check-prefix=CHECK-INST
# RUN: llvm-mc -triple=riscv64 -filetype=obj --mattr=+experimental-v,experimental-zvlsseg %s \
# RUN:        | llvm-objdump -d - | FileCheck %s --check-prefix=CHECK-UNKNOWN

vlseg2b.v v8, (a1), v0.t
# CHECK-INST: vlseg2b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0x30]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 30 <unknown>

vlseg2b.v v8, (a1)
# CHECK-INST: vlseg2b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0x32]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 32 <unknown>

vlseg2h.v v8, (a1), v0.t
# CHECK-INST: vlseg2h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0x30]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 30 <unknown>

vlseg2h.v v8, (a1)
# CHECK-INST: vlseg2h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0x32]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 32 <unknown>

vlseg2w.v v8, (a1), v0.t
# CHECK-INST: vlseg2w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0x30]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 30 <unknown>

vlseg2w.v v8, (a1)
# CHECK-INST: vlseg2w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0x32]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 32 <unknown>

vlseg2e.v v8, (a1), v0.t
# CHECK-INST: vlseg2e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0x20]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 20 <unknown>

vlseg2e.v v8, (a1)
# CHECK-INST: vlseg2e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0x22]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 22 <unknown>

vlseg3b.v v8, (a1), v0.t
# CHECK-INST: vlseg3b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0x50]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 50 <unknown>

vlseg3b.v v8, (a1)
# CHECK-INST: vlseg3b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0x52]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 52 <unknown>

vlseg3h.v v8, (a1), v0.t
# CHECK-INST: vlseg3h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0x50]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 50 <unknown>

vlseg3h.v v8, (a1)
# CHECK-INST: vlseg3h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0x52]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 52 <unknown>

vlseg3w.v v8, (a1), v0.t
# CHECK-INST: vlseg3w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0x50]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 50 <unknown>

vlseg3w.v v8, (a1)
# CHECK-INST: vlseg3w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0x52]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 52 <unknown>

vlseg3e.v v8, (a1), v0.t
# CHECK-INST: vlseg3e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0x40]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 40 <unknown>

vlseg3e.v v8, (a1)
# CHECK-INST: vlseg3e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0x42]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 42 <unknown>

vlseg4b.v v8, (a1), v0.t
# CHECK-INST: vlseg4b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0x70]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 70 <unknown>

vlseg4b.v v8, (a1)
# CHECK-INST: vlseg4b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0x72]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 72 <unknown>

vlseg4h.v v8, (a1), v0.t
# CHECK-INST: vlseg4h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0x70]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 70 <unknown>

vlseg4h.v v8, (a1)
# CHECK-INST: vlseg4h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0x72]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 72 <unknown>

vlseg4w.v v8, (a1), v0.t
# CHECK-INST: vlseg4w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0x70]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 70 <unknown>

vlseg4w.v v8, (a1)
# CHECK-INST: vlseg4w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0x72]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 72 <unknown>

vlseg4e.v v8, (a1), v0.t
# CHECK-INST: vlseg4e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0x60]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 60 <unknown>

vlseg4e.v v8, (a1)
# CHECK-INST: vlseg4e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0x62]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 62 <unknown>

vlseg5b.v v8, (a1), v0.t
# CHECK-INST: vlseg5b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0x90]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 90 <unknown>

vlseg5b.v v8, (a1)
# CHECK-INST: vlseg5b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0x92]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 92 <unknown>

vlseg5h.v v8, (a1), v0.t
# CHECK-INST: vlseg5h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0x90]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 90 <unknown>

vlseg5h.v v8, (a1)
# CHECK-INST: vlseg5h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0x92]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 92 <unknown>

vlseg5w.v v8, (a1), v0.t
# CHECK-INST: vlseg5w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0x90]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 90 <unknown>

vlseg5w.v v8, (a1)
# CHECK-INST: vlseg5w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0x92]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 92 <unknown>

vlseg5e.v v8, (a1), v0.t
# CHECK-INST: vlseg5e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0x80]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 80 <unknown>

vlseg5e.v v8, (a1)
# CHECK-INST: vlseg5e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0x82]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 82 <unknown>

vlseg6b.v v8, (a1), v0.t
# CHECK-INST: vlseg6b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0xb0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 b0 <unknown>

vlseg6b.v v8, (a1)
# CHECK-INST: vlseg6b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0xb2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 b2 <unknown>

vlseg6h.v v8, (a1), v0.t
# CHECK-INST: vlseg6h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0xb0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 b0 <unknown>

vlseg6h.v v8, (a1)
# CHECK-INST: vlseg6h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0xb2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 b2 <unknown>

vlseg6w.v v8, (a1), v0.t
# CHECK-INST: vlseg6w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0xb0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 b0 <unknown>

vlseg6w.v v8, (a1)
# CHECK-INST: vlseg6w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0xb2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 b2 <unknown>

vlseg6e.v v8, (a1), v0.t
# CHECK-INST: vlseg6e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0xa0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 a0 <unknown>

vlseg6e.v v8, (a1)
# CHECK-INST: vlseg6e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0xa2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 a2 <unknown>

vlseg7b.v v8, (a1), v0.t
# CHECK-INST: vlseg7b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0xd0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 d0 <unknown>

vlseg7b.v v8, (a1)
# CHECK-INST: vlseg7b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0xd2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 d2 <unknown>

vlseg7h.v v8, (a1), v0.t
# CHECK-INST: vlseg7h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0xd0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 d0 <unknown>

vlseg7h.v v8, (a1)
# CHECK-INST: vlseg7h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0xd2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 d2 <unknown>

vlseg7w.v v8, (a1), v0.t
# CHECK-INST: vlseg7w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0xd0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 d0 <unknown>

vlseg7w.v v8, (a1)
# CHECK-INST: vlseg7w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0xd2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 d2 <unknown>

vlseg7e.v v8, (a1), v0.t
# CHECK-INST: vlseg7e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0xc0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 c0 <unknown>

vlseg7e.v v8, (a1)
# CHECK-INST: vlseg7e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0xc2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 c2 <unknown>

vlseg8b.v v8, (a1), v0.t
# CHECK-INST: vlseg8b.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0x84,0x05,0xf0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 f0 <unknown>

vlseg8b.v v8, (a1)
# CHECK-INST: vlseg8b.v v8, (a1)
# CHECK-ENCODING: [0x07,0x84,0x05,0xf2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 84 05 f2 <unknown>

vlseg8h.v v8, (a1), v0.t
# CHECK-INST: vlseg8h.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xd4,0x05,0xf0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 f0 <unknown>

vlseg8h.v v8, (a1)
# CHECK-INST: vlseg8h.v v8, (a1)
# CHECK-ENCODING: [0x07,0xd4,0x05,0xf2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 d4 05 f2 <unknown>

vlseg8w.v v8, (a1), v0.t
# CHECK-INST: vlseg8w.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xe4,0x05,0xf0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 f0 <unknown>

vlseg8w.v v8, (a1)
# CHECK-INST: vlseg8w.v v8, (a1)
# CHECK-ENCODING: [0x07,0xe4,0x05,0xf2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 e4 05 f2 <unknown>

vlseg8e.v v8, (a1), v0.t
# CHECK-INST: vlseg8e.v v8, (a1), v0.t
# CHECK-ENCODING: [0x07,0xf4,0x05,0xe0]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 e0 <unknown>

vlseg8e.v v8, (a1)
# CHECK-INST: vlseg8e.v v8, (a1)
# CHECK-ENCODING: [0x07,0xf4,0x05,0xe2]
# CHECK-ERROR: instruction requires the following: 'V' (Vector Instructions), 'Zvlsseg' (Vector segment load/store instructions)
# CHECK-UNKNOWN: 07 f4 05 e2 <unknown>
