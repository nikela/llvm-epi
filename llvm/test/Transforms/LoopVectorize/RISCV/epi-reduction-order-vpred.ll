...
; CHECK-NEXT:    [[VEC_IV:%.*]] = add <vscale x 8 x i64> [[BROADCAST_SPLAT3]], [[TMP5]]
; CHECK-NEXT:    [[TMP6:%.*]] = icmp ule <vscale x 8 x i64> [[VEC_IV]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP7:%.*]] = sub i64 [[T0]], [[INDEX]]
...
; CHECK1-NEXT:    [[TMP4:%.*]] = call <vscale x 2 x i64> @llvm.experimental.stepvector.nxv2i64()
; CHECK1-NEXT:    [[TMP5:%.*]] = add <vscale x 2 x i64> zeroinitializer, [[TMP4]]
; CHECK1-NEXT:    [[VEC_IV:%.*]] = add <vscale x 2 x i64> [[BROADCAST_SPLAT3]], [[TMP5]]
; CHECK1-NEXT:    [[TMP6:%.*]] = icmp ule <vscale x 2 x i64> [[VEC_IV]], [[BROADCAST_SPLAT]]
; CHECK1-NEXT:    [[TMP7:%.*]] = sub i64 [[T0]], [[INDEX]]
...
; CHECK1-NEXT:    [[EVL_SPLATINSERT:%.*]] = insertelement <vscale x 2 x i32> poison, i32 [[TMP9]], i32 0
...
; CHECK1-NEXT:    [[TMP14:%.*]] = zext i32 [[TMP9]] to i64
