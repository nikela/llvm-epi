...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 16 x i64> poison, i64 [[INDEX]], i32 0
...
; CHECK-NEXT:    [[TMP9:%.*]] = call <vscale x 16 x i64> @llvm.experimental.stepvector.nxv16i64()
; CHECK-NEXT:    [[TMP10:%.*]] = add <vscale x 16 x i64> zeroinitializer, [[TMP9]]
; CHECK-NEXT:    [[VEC_IV:%.*]] = add <vscale x 16 x i64> [[BROADCAST_SPLAT]], [[TMP10]]
; CHECK-NEXT:    [[TMP11:%.*]] = icmp ule <vscale x 16 x i64> [[VEC_IV]], shufflevector (<vscale x 16 x i64> insertelement (<vscale x 16 x i64> poison, i64 4, i32 0), <vscale x 16 x i64> poison, <vscale x 16 x i32> zeroinitializer)
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, i8* [[SRC:%.*]], i64 [[TMP8]]
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i8, i8* [[TMP12]], i32 0
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i8* [[TMP13]] to <vscale x 16 x i8>*
; CHECK-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <vscale x 16 x i8> @llvm.masked.load.nxv16i8.p0nxv16i8(<vscale x 16 x i8>* [[TMP14]], i32 1, <vscale x 16 x i1> [[TMP11]], <vscale x 16 x i8> poison)
; CHECK-NEXT:    [[TMP15:%.*]] = shl <vscale x 16 x i8> [[WIDE_MASKED_LOAD]], shufflevector (<vscale x 16 x i8> insertelement (<vscale x 16 x i8> poison, i8 1, i32 0), <vscale x 16 x i8> poison, <vscale x 16 x i32> zeroinitializer)
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i8, i8* [[DST:%.*]], i64 [[TMP8]]
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i8, i8* [[TMP16]], i32 0
; CHECK-NEXT:    [[TMP18:%.*]] = bitcast i8* [[TMP17]] to <vscale x 16 x i8>*
; CHECK-NEXT:    [[WIDE_MASKED_LOAD1:%.*]] = call <vscale x 16 x i8> @llvm.masked.load.nxv16i8.p0nxv16i8(<vscale x 16 x i8>* [[TMP18]], i32 1, <vscale x 16 x i1> [[TMP11]], <vscale x 16 x i8> poison)
; CHECK-NEXT:    [[TMP19:%.*]] = add <vscale x 16 x i8> [[TMP15]], [[WIDE_MASKED_LOAD1]]
; CHECK-NEXT:    [[TMP20:%.*]] = bitcast i8* [[TMP17]] to <vscale x 16 x i8>*
; CHECK-NEXT:    call void @llvm.masked.store.nxv16i8.p0nxv16i8(<vscale x 16 x i8> [[TMP19]], <vscale x 16 x i8>* [[TMP20]], i32 1, <vscale x 16 x i1> [[TMP11]])
