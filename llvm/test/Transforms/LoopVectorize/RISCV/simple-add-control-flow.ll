...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x double> @llvm.vp.load.nxv8f64.p0nxv8f64(<vscale x 8 x double>* [[TMP6]], i32 8, <vscale x 8 x i1> [[DOTSPLAT]], i32 [[TMP7]])
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK-NEXT:    [[VP_OP_FCMP:%.*]] = call <vscale x 8 x i1> @llvm.vp.fcmp.nxv8f64(<vscale x 8 x double> [[VP_OP_LOAD]], <vscale x 8 x double> [[BROADCAST_SPLAT4]], i8 4, <vscale x 8 x i1> [[DOTSPLAT]], i32 [[TMP8]])
; CHECK-NEXT:    [[TMP9:%.*]] = select <vscale x 8 x i1> [[DOTSPLAT]], <vscale x 8 x i1> [[VP_OP_FCMP]], <vscale x 8 x i1> zeroinitializer
...
; CHECK-NEXT:    [[VP_OP_LOAD9:%.*]] = call <vscale x 8 x double> @llvm.vp.load.nxv8f64.p0nxv8f64(<vscale x 8 x double>* [[TMP12]], i32 8, <vscale x 8 x i1> [[DOTSPLAT]], i32 [[TMP13]])
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv8f64.p0nxv8f64(<vscale x 8 x double> [[VP_OP15]], <vscale x 8 x double>* [[TMP27]], i32 8, <vscale x 8 x i1> [[TMP25]], i32 [[TMP28]])
...
; CHECK1-NEXT:    [[TMP1:%.*]] = icmp ule <vscale x 1 x i64> [[INDUCTION]], [[BROADCAST_SPLAT]]
; CHECK1-NEXT:    [[TMP2:%.*]] = getelementptr inbounds double, double* [[C:%.*]], i64 [[TMP0]]
; CHECK1-NEXT:    [[TMP3:%.*]] = sub i64 [[WIDE_TRIP_COUNT]], [[INDEX]]
; CHECK1-NEXT:    [[TMP4:%.*]] = call i64 @llvm.epi.vsetvl(i64 [[TMP3]], i64 3, i64 0)
; CHECK1-NEXT:    [[TMP5:%.*]] = getelementptr inbounds double, double* [[TMP2]], i32 0
...
; CHECK1-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 1 x double> @llvm.vp.load.nxv1f64.p0nxv1f64(<vscale x 1 x double>* [[TMP6]], i32 8, <vscale x 1 x i1> [[DOTSPLAT]], i32 [[TMP7]])
; CHECK1-NEXT:    [[TMP8:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    [[VP_OP_FCMP:%.*]] = call <vscale x 1 x i1> @llvm.vp.fcmp.nxv1f64(<vscale x 1 x double> [[VP_OP_LOAD]], <vscale x 1 x double> [[BROADCAST_SPLAT4]], i8 4, <vscale x 1 x i1> [[DOTSPLAT]], i32 [[TMP8]])
; CHECK1-NEXT:    [[TMP9:%.*]] = select <vscale x 1 x i1> [[DOTSPLAT]], <vscale x 1 x i1> [[VP_OP_FCMP]], <vscale x 1 x i1> zeroinitializer
...
; CHECK1-NEXT:    [[TMP13:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    [[VP_OP_LOAD9:%.*]] = call <vscale x 1 x double> @llvm.vp.load.nxv1f64.p0nxv1f64(<vscale x 1 x double>* [[TMP12]], i32 8, <vscale x 1 x i1> [[DOTSPLAT]], i32 [[TMP13]])
...
; CHECK1-NEXT:    [[TMP17:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    [[VP_OP_LOAD12:%.*]] = call <vscale x 1 x double> @llvm.vp.load.nxv1f64.p0nxv1f64(<vscale x 1 x double>* [[TMP16]], i32 8, <vscale x 1 x i1> [[DOTSPLAT]], i32 [[TMP17]])
; CHECK1-NEXT:    [[TMP18:%.*]] = xor <vscale x 1 x i1> [[TMP9]], [[DOTSPLAT]]
; CHECK1-NEXT:    [[TMP19:%.*]] = and <vscale x 1 x i1> [[TMP18]], [[TMP1]]
; CHECK1-NEXT:    [[TMP20:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    [[VP_OP:%.*]] = call <vscale x 1 x double> @llvm.vp.fmul.nxv1f64(<vscale x 1 x double> [[VP_OP_LOAD9]], <vscale x 1 x double> [[VP_OP_LOAD12]], metadata !"round.tonearest", metadata !"fpexcept.ignore", <vscale x 1 x i1> [[TMP19]], i32 [[TMP20]])
; CHECK1-NEXT:    [[TMP21:%.*]] = getelementptr inbounds double, double* [[D:%.*]], i64 [[TMP0]]
...
; CHECK1-NEXT:    [[TMP24:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    call void @llvm.vp.store.nxv1f64.p0nxv1f64(<vscale x 1 x double> [[VP_OP]], <vscale x 1 x double>* [[TMP23]], i32 8, <vscale x 1 x i1> [[TMP19]], i32 [[TMP24]])
; CHECK1-NEXT:    [[TMP25:%.*]] = and <vscale x 1 x i1> [[TMP9]], [[TMP1]]
; CHECK1-NEXT:    [[TMP26:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    [[VP_OP15:%.*]] = call <vscale x 1 x double> @llvm.vp.fadd.nxv1f64(<vscale x 1 x double> [[VP_OP_LOAD9]], <vscale x 1 x double> [[VP_OP_LOAD12]], metadata !"round.tonearest", metadata !"fpexcept.ignore", <vscale x 1 x i1> [[TMP25]], i32 [[TMP26]])
; CHECK1-NEXT:    [[TMP27:%.*]] = bitcast double* [[TMP5]] to <vscale x 1 x double>*
; CHECK1-NEXT:    [[TMP28:%.*]] = trunc i64 [[TMP4]] to i32
; CHECK1-NEXT:    call void @llvm.vp.store.nxv1f64.p0nxv1f64(<vscale x 1 x double> [[VP_OP15]], <vscale x 1 x double>* [[TMP27]], i32 8, <vscale x 1 x i1> [[TMP25]], i32 [[TMP28]])
...
; CHECK1-NEXT:    [[CMP1:%.*]] = fcmp olt double [[TMP30]], 3.000000e+00
; CHECK1-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds double, double* [[A]], i64 [[INDVARS_IV]]
; CHECK1-NEXT:    [[TMP31:%.*]] = load double, double* [[ARRAYIDX3]], align 8
; CHECK1-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds double, double* [[B]], i64 [[INDVARS_IV]]
; CHECK1-NEXT:    [[TMP32:%.*]] = load double, double* [[ARRAYIDX5]], align 8
