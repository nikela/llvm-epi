...
; STRIDED-NEXT:    [[VP_STRIDED_LOAD:%.*]] = call <vscale x 2 x float> @llvm.vp.strided.load.nxv2f32.p0f32.i64(float* [[TMP8]], i64 8, <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]])
; STRIDED-NEXT:    [[TMP9:%.*]] = shl i64 [[INDEX]], 1
; STRIDED-NEXT:    [[TMP10:%.*]] = getelementptr float, float* [[SCEVGEP]], i64 [[TMP9]]
; STRIDED-NEXT:    [[VP_STRIDED_LOAD4:%.*]] = call <vscale x 2 x float> @llvm.vp.strided.load.nxv2f32.p0f32.i64(float* [[TMP10]], i64 8, <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]])
; STRIDED-NEXT:    [[TMP11:%.*]] = getelementptr { float, float }, { float, float }* [[Y]], i64 [[INDEX]], i32 0
; STRIDED-NEXT:    [[VP_STRIDED_LOAD5:%.*]] = call <vscale x 2 x float> @llvm.vp.strided.load.nxv2f32.p0f32.i64(float* [[TMP11]], i64 8, <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]])
; STRIDED-NEXT:    [[TMP12:%.*]] = shl i64 [[INDEX]], 1
; STRIDED-NEXT:    [[TMP13:%.*]] = getelementptr float, float* [[SCEVGEP6]], i64 [[TMP12]]
; STRIDED-NEXT:    [[VP_STRIDED_LOAD8:%.*]] = call <vscale x 2 x float> @llvm.vp.strided.load.nxv2f32.p0f32.i64(float* [[TMP13]], i64 8, <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]])
...
; STRIDED-NEXT:    [[VP_STRIDED_LOAD19:%.*]] = call <vscale x 2 x float> @llvm.vp.strided.load.nxv2f32.p0f32.i64(float* [[TMP17]], i64 [[TMP1]], <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]])
...
; STRIDED-NEXT:    [[VP_STRIDED_LOAD26:%.*]] = call <vscale x 2 x float> @llvm.vp.strided.load.nxv2f32.p0f32.i64(float* [[TMP21]], i64 [[TMP2]], <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]])
...
; STRIDED-NEXT:    call void @llvm.vp.strided.store.nxv2f32.p0f32.i64(<vscale x 2 x float> [[VP_OP32]], float* [[TMP25]], i64 [[TMP3]], <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]]), !llvm.access.group !4
...
; STRIDED-NEXT:    call void @llvm.vp.strided.store.nxv2f32.p0f32.i64(<vscale x 2 x float> [[VP_OP36]], float* [[TMP29]], i64 [[TMP4]], <vscale x 2 x i1> shufflevector (<vscale x 2 x i1> insertelement (<vscale x 2 x i1> poison, i1 true, i32 0), <vscale x 2 x i1> poison, <vscale x 2 x i32> zeroinitializer), i32 [[TMP7]]), !llvm.access.group !4
