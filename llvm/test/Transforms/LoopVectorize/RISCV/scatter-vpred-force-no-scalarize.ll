...
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8f64.nxv8p0f64(<vscale x 8 x double> shufflevector (<vscale x 8 x double> insertelement (<vscale x 8 x double> undef, double 0.000000e+00, i32 0), <vscale x 8 x double> undef, <vscale x 8 x i32> zeroinitializer), <vscale x 8 x double*> [[TMP6]], i32 8, <vscale x 8 x i1> [[TMP1]], i32 [[TMP7]])
