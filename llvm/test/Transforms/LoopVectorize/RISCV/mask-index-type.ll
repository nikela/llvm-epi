...
; VLENUNK-NEXT:    [[TMP6:%.*]] = mul <vscale x 4 x i64> [[TMP5]], shufflevector (<vscale x 4 x i64> insertelement (<vscale x 4 x i64> poison, i64 1, i32 0), <vscale x 4 x i64> poison, <vscale x 4 x i32> zeroinitializer)
...
; VLENUNK-NEXT:    [[DOTSPLATINSERT:%.*]] = insertelement <vscale x 4 x i64> poison, i64 [[TMP9]], i32 0
...
; VLENUNK-NEXT:    [[BROADCAST_SPLATINSERT4:%.*]] = insertelement <vscale x 4 x i32> poison, i32 [[V]], i32 0
; VLENUNK-NEXT:    [[BROADCAST_SPLAT5:%.*]] = shufflevector <vscale x 4 x i32> [[BROADCAST_SPLATINSERT4]], <vscale x 4 x i32> poison, <vscale x 4 x i32> zeroinitializer
...
; VLENUNK-NEXT:    [[STEP_ADD:%.*]] = add <vscale x 4 x i64> [[VEC_IND]], [[DOTSPLAT]]
; VLENUNK-NEXT:    [[TMP10:%.*]] = add i64 [[INDEX]], 0
; VLENUNK-NEXT:    [[TMP11:%.*]] = call i64 @llvm.vscale.i64()
; VLENUNK-NEXT:    [[TMP12:%.*]] = mul i64 [[TMP11]], 4
; VLENUNK-NEXT:    [[TMP13:%.*]] = add i64 [[TMP12]], 0
; VLENUNK-NEXT:    [[TMP14:%.*]] = mul i64 [[TMP13]], 1
; VLENUNK-NEXT:    [[TMP15:%.*]] = add i64 [[INDEX]], [[TMP14]]
; VLENUNK-NEXT:    [[TMP16:%.*]] = icmp ult <vscale x 4 x i64> [[VEC_IND]], shufflevector (<vscale x 4 x i64> insertelement (<vscale x 4 x i64> poison, i64 512, i32 0), <vscale x 4 x i64> poison, <vscale x 4 x i32> zeroinitializer)
; VLENUNK-NEXT:    [[TMP17:%.*]] = icmp ult <vscale x 4 x i64> [[STEP_ADD]], shufflevector (<vscale x 4 x i64> insertelement (<vscale x 4 x i64> poison, i64 512, i32 0), <vscale x 4 x i64> poison, <vscale x 4 x i32> zeroinitializer)
...
; VLENUNK-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr [[TMP20]], i32 4, <vscale x 4 x i1> [[TMP16]], <vscale x 4 x i32> poison)
; VLENUNK-NEXT:    [[TMP21:%.*]] = call i32 @llvm.vscale.i32()
; VLENUNK-NEXT:    [[TMP22:%.*]] = mul i32 [[TMP21]], 4
; VLENUNK-NEXT:    [[TMP23:%.*]] = getelementptr i32, ptr [[TMP18]], i32 [[TMP22]]
; VLENUNK-NEXT:    [[WIDE_MASKED_LOAD2:%.*]] = call <vscale x 4 x i32> @llvm.masked.load.nxv4i32.p0(ptr [[TMP23]], i32 4, <vscale x 4 x i1> [[TMP17]], <vscale x 4 x i32> poison)
; VLENUNK-NEXT:    [[TMP24:%.*]] = xor <vscale x 4 x i1> [[TMP16]], shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
; VLENUNK-NEXT:    [[TMP25:%.*]] = xor <vscale x 4 x i1> [[TMP17]], shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i32 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer)
; VLENUNK-NEXT:    [[PREDPHI:%.*]] = select <vscale x 4 x i1> [[TMP24]], <vscale x 4 x i32> zeroinitializer, <vscale x 4 x i32> [[WIDE_MASKED_LOAD]]
; VLENUNK-NEXT:    [[PREDPHI3:%.*]] = select <vscale x 4 x i1> [[TMP25]], <vscale x 4 x i32> zeroinitializer, <vscale x 4 x i32> [[WIDE_MASKED_LOAD2]]
; VLENUNK-NEXT:    [[TMP26:%.*]] = add <vscale x 4 x i32> [[PREDPHI]], [[BROADCAST_SPLAT]]
; VLENUNK-NEXT:    [[TMP27:%.*]] = add <vscale x 4 x i32> [[PREDPHI3]], [[BROADCAST_SPLAT5]]
...
; VLENUNK-NEXT:    store <vscale x 4 x i32> [[TMP26]], ptr [[TMP30]], align 4
; VLENUNK-NEXT:    [[TMP31:%.*]] = call i32 @llvm.vscale.i32()
; VLENUNK-NEXT:    [[TMP32:%.*]] = mul i32 [[TMP31]], 4
; VLENUNK-NEXT:    [[TMP33:%.*]] = getelementptr inbounds i32, ptr [[TMP28]], i32 [[TMP32]]
; VLENUNK-NEXT:    store <vscale x 4 x i32> [[TMP27]], ptr [[TMP33]], align 4
; VLENUNK-NEXT:    [[TMP34:%.*]] = call i64 @llvm.vscale.i64()
; VLENUNK-NEXT:    [[TMP35:%.*]] = mul i64 [[TMP34]], 8
; VLENUNK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP35]]
; VLENUNK-NEXT:    [[VEC_IND_NEXT]] = add <vscale x 4 x i64> [[STEP_ADD]], [[DOTSPLAT]]
