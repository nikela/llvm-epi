...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 8 x double>, <vscale x 8 x double>* [[TMP13]], align 8, [[TBAA2:!tbaa !.*]]
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds double, double* [[DY:%.*]], i64 [[TMP8]]
...
; CHECK-NEXT:    [[WIDE_LOAD1:%.*]] = load <vscale x 8 x double>, <vscale x 8 x double>* [[TMP18]], align 8, [[TBAA2]]
; CHECK-NEXT:    [[TMP19:%.*]] = fadd <vscale x 8 x double> [[WIDE_LOAD]], [[WIDE_LOAD1]]
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds double, double* [[DZ:%.*]], i64 [[TMP8]]
; CHECK-NEXT:    [[TMP21:%.*]] = call i32 @llvm.vscale.i32()
; CHECK-NEXT:    [[TMP22:%.*]] = mul i32 [[TMP21]], 0
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr inbounds double, double* [[TMP20]], i32 [[TMP22]]
; CHECK-NEXT:    [[TMP24:%.*]] = bitcast double* [[TMP23]] to <vscale x 8 x double>*
; CHECK-NEXT:    store <vscale x 8 x double> [[TMP19]], <vscale x 8 x double>* [[TMP24]], align 8, [[TBAA2]]
...
; CHECK-NEXT:    [[TMP28:%.*]] = load double, double* [[ARRAYIDX]], align 8, [[TBAA2]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, double* [[DY]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    [[TMP29:%.*]] = load double, double* [[ARRAYIDX2]], align 8, [[TBAA2]]
...
; CHECK1-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 1 x double>, <vscale x 1 x double>* [[TMP11]], align 8, [[TBAA2:!tbaa !.*]]
; CHECK1-NEXT:    [[TMP12:%.*]] = getelementptr inbounds double, double* [[DY:%.*]], i64 [[TMP6]]
...
; CHECK1-NEXT:    [[WIDE_LOAD1:%.*]] = load <vscale x 1 x double>, <vscale x 1 x double>* [[TMP16]], align 8, [[TBAA2]]
; CHECK1-NEXT:    [[TMP17:%.*]] = fadd <vscale x 1 x double> [[WIDE_LOAD]], [[WIDE_LOAD1]]
; CHECK1-NEXT:    [[TMP18:%.*]] = getelementptr inbounds double, double* [[DZ:%.*]], i64 [[TMP6]]
; CHECK1-NEXT:    [[TMP19:%.*]] = call i32 @llvm.vscale.i32()
; CHECK1-NEXT:    [[TMP20:%.*]] = mul i32 [[TMP19]], 0
; CHECK1-NEXT:    [[TMP21:%.*]] = getelementptr inbounds double, double* [[TMP18]], i32 [[TMP20]]
; CHECK1-NEXT:    [[TMP22:%.*]] = bitcast double* [[TMP21]] to <vscale x 1 x double>*
; CHECK1-NEXT:    store <vscale x 1 x double> [[TMP17]], <vscale x 1 x double>* [[TMP22]], align 8, [[TBAA2]]
...
; CHECK1-NEXT:    br i1 [[TMP24]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], [[LOOP6:!llvm.loop !.*]]
; CHECK1:       middle.block:
...
; CHECK1-NEXT:    [[TMP25:%.*]] = load double, double* [[ARRAYIDX]], align 8, [[TBAA2]]
; CHECK1-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, double* [[DY]], i64 [[INDVARS_IV]]
; CHECK1-NEXT:    [[TMP26:%.*]] = load double, double* [[ARRAYIDX2]], align 8, [[TBAA2]]
; CHECK1-NEXT:    [[ADD:%.*]] = fadd double [[TMP25]], [[TMP26]]
