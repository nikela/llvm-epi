...
; CHECK-NEXT:    [[STEP_VSCALE1:%.*]] = mul i64 8, [[TMP1]]
...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 8 x double>, <vscale x 8 x double>* [[TMP5]], align 8, [[TBAA2:!tbaa !.*]]
...
; CHECK-NEXT:    [[WIDE_LOAD2:%.*]] = load <vscale x 8 x double>, <vscale x 8 x double>* [[TMP8]], align 8, [[TBAA2]]
; CHECK-NEXT:    [[TMP9:%.*]] = fadd <vscale x 8 x double> [[WIDE_LOAD]], [[WIDE_LOAD2]]
...
; CHECK-NEXT:    store <vscale x 8 x double> [[TMP9]], <vscale x 8 x double>* [[TMP12]], align 8, [[TBAA2]]
...
; CHECK1-NEXT:    [[STEP_VSCALE:%.*]] = mul i64 [[TMP0]], 1
; CHECK1-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[WIDE_TRIP_COUNT]], [[STEP_VSCALE]]
; CHECK1-NEXT:    br i1 [[MIN_ITERS_CHECK]], label [[SCALAR_PH:%.*]], label [[VECTOR_PH:%.*]]
; CHECK1:       vector.ph:
; CHECK1-NEXT:    [[TMP1:%.*]] = call i64 @llvm.vscale.i64()
; CHECK1-NEXT:    [[STEP_VSCALE1:%.*]] = mul i64 1, [[TMP1]]
; CHECK1-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[WIDE_TRIP_COUNT]], [[STEP_VSCALE1]]
...
; CHECK1-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 1 x double>, <vscale x 1 x double>* [[TMP5]], align 8, [[TBAA2:!tbaa !.*]]
; CHECK1-NEXT:    [[TMP6:%.*]] = getelementptr inbounds double, double* [[DY:%.*]], i64 [[TMP2]]
; CHECK1-NEXT:    [[TMP7:%.*]] = getelementptr inbounds double, double* [[TMP6]], i32 0
; CHECK1-NEXT:    [[TMP8:%.*]] = bitcast double* [[TMP7]] to <vscale x 1 x double>*
; CHECK1-NEXT:    [[WIDE_LOAD2:%.*]] = load <vscale x 1 x double>, <vscale x 1 x double>* [[TMP8]], align 8, [[TBAA2]]
; CHECK1-NEXT:    [[TMP9:%.*]] = fadd <vscale x 1 x double> [[WIDE_LOAD]], [[WIDE_LOAD2]]
; CHECK1-NEXT:    [[TMP10:%.*]] = getelementptr inbounds double, double* [[DZ:%.*]], i64 [[TMP2]]
...
; CHECK1-NEXT:    store <vscale x 1 x double> [[TMP9]], <vscale x 1 x double>* [[TMP12]], align 8, [[TBAA2]]
...
; CHECK1-NEXT:    [[TMP15:%.*]] = load double, double* [[ARRAYIDX]], align 8, [[TBAA2]]
; CHECK1-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, double* [[DY]], i64 [[INDVARS_IV]]
; CHECK1-NEXT:    [[TMP16:%.*]] = load double, double* [[ARRAYIDX2]], align 8, [[TBAA2]]
; CHECK1-NEXT:    [[ADD:%.*]] = fadd double [[TMP15]], [[TMP16]]
; CHECK1-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds double, double* [[DZ]], i64 [[INDVARS_IV]]
; CHECK1-NEXT:    store double [[ADD]], double* [[ARRAYIDX4]], align 8, [[TBAA2]]
