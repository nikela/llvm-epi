...
; ModuleID = 'custom/LoopVectorize/declare_simd.c'
source_filename = "custom/LoopVectorize/declare_simd.c"
...
; CHECK-NEXT:    [[CALL:%.*]] = tail call float @foo(float noundef [[TMP17]], float noundef [[TMP18]]) #[[ATTR5:[0-9]+]], !llvm.access.group [[ACC_GRP9]]
...
attributes #1 = { "_ZGVEMk1vv_foo" "_ZGVEMk2vv_foo" "_ZGVEMk4vv_foo" "_ZGVEMk8vv_foo" "_ZGVENk1vv_foo" "_ZGVENk2vv_foo" "_ZGVENk4vv_foo" "_ZGVENk8vv_foo" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+64bit,+a,+c,+d,+f,+m,+zepi,+zve32f,+zve32x,+zve64d,+zve64f,+zve64x,+zvl32b,+zvl64b,-relax,-save-restore" }
