...
subroutine s(var)
  ...
  !ERROR: Unsupported REAL(KIND=13)
  real :: realvar5 = 4.0Q6_13
  !WARNING: Explicit kind parameter on real constant disagrees with exponent letter 'q'
  real :: realvar6 = 4.0Q6_8
  real :: realvar7 = 4.0E6_8
  !ERROR: Unsupported REAL(KIND=13)
  real :: realvar8 = 4.0E6_13
  real :: realvar9 = 4.0E6_8
  ...
  !WARNING: Explicit kind parameter on real constant disagrees with exponent letter 'q'
  double precision :: doublevar5 = 4.0Q6_8
  double precision :: doublevar6 = 4.0E6_8
  !ERROR: Unsupported REAL(KIND=13)
  double precision :: doublevar7 = 4.0E6_13
  double precision :: doublevar8 = 4.0E6_8
  !ERROR: Unsupported REAL(KIND=32)
