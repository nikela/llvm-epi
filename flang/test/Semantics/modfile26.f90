...
module m1
  ...
  integer, parameter :: iranges(*) = &
    [range(0_1), range(0_2), range(0_4), range(0_8)]
  logical, parameter :: ircheck = all([2, 4, 9, 18] == iranges)
  integer, parameter :: intpvals(*) = [0, 2, 3, 4, 5, 9, 10, 18, 39]
  integer, parameter :: intpkinds(*) = &
    [(selected_int_kind(intpvals(j)),j=1,size(intpvals))]
  logical, parameter :: ipcheck = &
    all([1, 1, 2, 2, 4, 4, 8, 8, -1] == intpkinds)
  ...
  integer, parameter :: realprecs(*) = &
    [precision(0._4), precision(0._8)]
  logical, parameter :: rpreccheck = all([6, 15] == realprecs)
  integer, parameter :: realpvals(*) = [0, 3, 4, 6, 7, 15, 34]
  integer, parameter :: realpkinds(*) = &
    [(selected_real_kind(realpvals(j),0),j=1,size(realpvals))]
  logical, parameter :: realpcheck = &
    all([4, 4, 4, 4, 8, 8, -1] == realpkinds)
  ...
  integer, parameter :: realranges(*) = &
    [range(0._4), range(0._8)]
  logical, parameter :: rrangecheck = &
    all([37, 307] == realranges)
  ...
  logical, parameter :: realrcheck = &
    all([4, 4, 4, 4, 8, 8, -2] == realrkinds)
  logical, parameter :: radixcheck = &
    all([radix(0._4), radix(0._8)] == 2)
  integer, parameter :: intdigits(*) = &
    [digits(0_1), digits(0_2), digits(0_4), digits(0_8)]
  logical, parameter :: intdigitscheck = &
    all([7, 15, 31, 63] == intdigits)
  integer, parameter :: realdigits(*) = &
    [digits(0._4), digits(0._8)]
  logical, parameter :: realdigitscheck = &
    all([24, 53] == realdigits)
end module m1
!Expect: m1.mod
!module m1
!integer(4),parameter::iranges(1_8:*)=[INTEGER(4)::2_4,4_4,9_4,18_4]
!intrinsic::range
!logical(4),parameter::ircheck=.true._4
!intrinsic::all
!integer(4),parameter::intpvals(1_8:*)=[INTEGER(4)::0_4,2_4,3_4,4_4,5_4,9_4,10_4,18_4,39_4]
!integer(4),parameter::intpkinds(1_8:*)=[INTEGER(4)::1_4,1_4,2_4,2_4,4_4,4_4,8_4,8_4,-1_4]
!intrinsic::selected_int_kind
!intrinsic::size
!logical(4),parameter::ipcheck=.true._4
!integer(4),parameter::realprecs(1_8:*)=[INTEGER(4)::6_4,15_4]
!intrinsic::precision
!logical(4),parameter::rpreccheck=.true._4
!integer(4),parameter::realpvals(1_8:*)=[INTEGER(4)::0_4,3_4,4_4,6_4,7_4,15_4,34_4]
!integer(4),parameter::realpkinds(1_8:*)=[INTEGER(4)::4_4,4_4,4_4,4_4,8_4,8_4,-1_4]
!intrinsic::selected_real_kind
!logical(4),parameter::realpcheck=.true._4
!integer(4),parameter::realranges(1_8:*)=[INTEGER(4)::37_4,307_4]
!logical(4),parameter::rrangecheck=.true._4
!integer(4),parameter::realrvals(1_8:*)=[INTEGER(4)::0_4,4_4,5_4,37_4,38_4,307_4,4932_4]
!integer(4),parameter::realrkinds(1_8:*)=[INTEGER(4)::4_4,4_4,4_4,4_4,8_4,8_4,-2_4]
!logical(4),parameter::realrcheck=.true._4
!logical(4),parameter::radixcheck=.true._4
!intrinsic::radix
!integer(4),parameter::intdigits(1_8:*)=[INTEGER(4)::7_4,15_4,31_4,63_4]
!intrinsic::digits
!logical(4),parameter::intdigitscheck=.true._4
!integer(4),parameter::realdigits(1_8:*)=[INTEGER(4)::24_4,53_4]
