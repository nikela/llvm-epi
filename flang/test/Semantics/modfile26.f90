...
module m1
  ...
  integer, parameter :: realprecs(*) = &
    [precision(0._4), precision(0._8), precision(0._16)]
  logical, parameter :: rpreccheck = all([6, 15, 33] == realprecs)
  ...
  logical, parameter :: realpcheck = &
    all([4, 4, 4, 4, 8, 8, 16, 16, 16, 16, -1] == realpkinds)
  ...
  integer, parameter :: realranges(*) = &
    [range(0._4), range(0._8), range(0._16)]
  logical, parameter :: rrangecheck = &
    all([37, 307, 4931] == realranges)
  ...
  logical, parameter :: realrcheck = &
    all([4, 4, 4, 4, 8, 8, 16, 16, -2] == realrkinds)
  logical, parameter :: radixcheck = &
    all([radix(0._4), radix(0._8), radix(0._16)] == 2)
  ...
  integer, parameter :: realdigits(*) = &
    [digits(0._4), digits(0._8), digits(0._16)]
  logical, parameter :: realdigitscheck = &
    all([24, 53, 113] == realdigits)
end module m1
!Expect: m1.mod
!module m1
...
!integer(4),parameter::realprecs(1_8:*)=[INTEGER(4)::6_4,15_4,33_4]
!intrinsic::precision
...
!integer(4),parameter::realpkinds(1_8:*)=[INTEGER(4)::4_4,4_4,4_4,4_4,8_4,8_4,16_4,16_4,16_4,16_4,-1_4]
!intrinsic::selected_real_kind
!logical(4),parameter::realpcheck=.true._4
!integer(4),parameter::realranges(1_8:*)=[INTEGER(4)::37_4,307_4,4931_4]
...
!integer(4),parameter::realrkinds(1_8:*)=[INTEGER(4)::4_4,4_4,4_4,4_4,8_4,8_4,16_4,16_4,-2_4]
...
!integer(4),parameter::realdigits(1_8:*)=[INTEGER(4)::24_4,53_4,113_4]
